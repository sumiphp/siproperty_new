...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 02, 2024 at 02:40 PM
...
--
ALTER TABLE `contactenquiries`
  MODIFY `enquiryid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;
...
--
ALTER TABLE `newslettersubscribe`
  MODIFY `newsletterid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
