 <header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="<?php echo base_url().'Home/index';?>"><img src="<?php echo base_url().'siproperty/assets/images/logo-light.png';?>" alt=""></a></figure>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="<?php echo base_url().'Home/categories';?>"><span>Categories</span></a></li>  
                                        <li><a href="<?php echo base_url().'Home/showcase';?>"><span>Gallery</span></a></li>  
                                        <li><a href="<?php echo base_url().'Home/homecare';?>"><span>Services</span></a></li>
                                        <li><a href="<?php echo base_url().'Home/blog';?>"><span>Blog</span></a></li> 
                                        <li><a href="<?php echo base_url().'Home/testimonials';?>"><span>Testimonials</span></a></li>      
                                        ...
                                        <li><a href="<?php echo base_url().'Home/contactUs';?>"><span>Contactiiii</span></a></li>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                ...
                <div class="contact-info">
                    <h4>Contact Info</h4>
                    <ul>
                        <li><?php echo $contactus->location;?></li>
                ...
                <div class="social-links">
                    <ul class="clearfix">
                        ...
                        <li><a href="<?php echo $settings->pinterest;?>" target=_blank><span class="fab fa-pinterest-p"></span></a></li>
