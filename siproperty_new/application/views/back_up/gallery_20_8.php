            ...
            <div class="auto-container">
                ...
                <div class="sortable-masonry">
                    ...
                    foreach($gallery as $gal){
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column <?php echo 'all'.' '.$int?>" >
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column <?php echo 'all'.' '.$ext?>" >
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'uploads/gallery/'.$gal['image']?>" alt=""></figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column <?php echo 'all'.' '.$fp?>" >
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                    <figure class="image"><img src="<?php echo base_url().'uploads/gallery/'.$gal['image']?>" alt=""></figure>
                        ...
                        <?php } ?>
                        <!--div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all floor_plan interior">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/gallery/interior1(370x275).jpg';?>" alt=""></figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all interior exterior">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/gallery/interior2(370x275).jpg';?>" alt=""></figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all floor_plan exterior">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/gallery/exterior(370x275)(2).jpg';?>" alt=""></figure>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all interior exterior">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/gallery/exterior2.jpg';?>" alt=""></figure>
