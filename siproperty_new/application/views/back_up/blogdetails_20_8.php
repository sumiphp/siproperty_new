...
<div class="boxed_wrapper">
    ...
    <div class="loader-wrap">
                ...
                <div class="outer-box">
                    <div class="main-box" style="height:100px;"> 
                        <div class="logo-box">
                            <figure class="logo">
                                <a href="index.html">
                                    <img style="width:6em; margin-left: 50px; margin-top: -30px;" src="<?php echo base_url().'siproperty/assets/images/logo-light1.png';?>" alt=""> 
                                </a>
                            </figure>
                        </div>
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img style="margin-top: -50px;" src="assets/images/logo-light1.png" alt="" title=""></a></div>
                ...
                <div class="auto-container">
                    <div class="top-details clearfix">
                        <div class="left-column pull-left clearfix">
                            <h3><?php echo $pd2->blogtitle;
                            //echo $pd1->project_name;?></h3>
                        ...
                        <div class="right-column pull-right clearfix">
                            <div class="price-inner clearfix">
                                <ul class="category clearfix pull-left">
                                    <span class="ml-5" style="font-size:18px ;">Added by</span>
                                   
                                </ul>
                                <div class="price-box pull-right">
                                    <h3>Admin<?php //echo $pd1->price;?></h3>
                                </div>
                            </div>
                            <div>
...
<?php //} ?>
                            ...
                            <!--div class="location-box content-widget">
                                ...
                                <div class="google-map-area">
                                    <div class="map">
                                        <h4>SI Property Leela Madhavam Legacy</h4>
                                        <iframe 
...
<iframe width="710" height="400" src="<?php echo $pd->videourl;?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                        ...
                        <div class="property-sidebar default-sidebar">
                            <div class="author-widget sidebar-widget">
                                ...
                                <div class="form-inner">
                                    ...
                                    <span id='msg1' style='color:green;font-weight:bold;'></span>
                                    <form id="frmcontact1" class="default-form" method="post" action="<?php echo base_url().'Home/contactusprocess';?>" >
                                        <div class="form-group">
                                            <input type="text" name="name" placeholder="Your name" style="height: 40px;" required="">
                                        </div>
                                        <div class="form-group">
                                ...
                                <div class="inner-box">
                                    ...
                                    <div class="lower-content">
                                        <div class="author-info clearfix">
                                            ...
                                            <div class="buy-btn pull-right"><a href="property-details.html">Contact Now</a></div>
                                        </div>
        ...
        <!-- subscribe-section -->
        <!--section class="subscribe-section bg-color-3" style="margin-top: -110px;">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget about-widget">
                                ...
                                <div class="row ml-1 mt-3">
                                    <img src="assets/images/logo r.png" alt="Company Logo" style="width: 20%; height: auto;">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget post-widget">
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        <figure class="post-thumb"><a href="#"><img src="assets/images/news/news-1.jpg" alt=""></a></figure>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="inner-box clearfix">
                        <figure class="footer-logo"><a href="index.html"><img style="width:6em; margin-top: 25px;" src="assets/images/logo-light.png" alt=""></a></figure>
