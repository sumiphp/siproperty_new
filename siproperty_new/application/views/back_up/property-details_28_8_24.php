                                    ...
                                    <!--li class="accordion block active-block">
                                        ...
                                        <div class="acc-content current">
                                            <div class="content-box">
                                                ...
                                                <figure class="image-box">
                                                    <img src="assets/images/resource/floor-1.jpg" alt="">
                                                </figure>
                                            </div>
                                        </div>
                                    </li>
...
$i++;
                                            ...
                                            <!--div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>Kerala University <span>(2.10 km)</span></h6>
                                                </div>
                                                
                                            </div>
                                            <div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>M.G University <span>(1.42 km)</span></h6>
                                                </div>
                                                                                            </div>
                                            <div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>Engineering College <span>(2.10 km)</span></h6>
                                                </div>
                                                                                            </div-->
                                        </div>
                                    </div>
...
$i++;
                                            ...
                                            <!--div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>SP Fort Hospital <span>(3.10 km)</span></h6>
                                                </div>
                                                                                            </div>
                                            <div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>Kims Hospital<span>(2.42 km)</span></h6>
                                                </div>
                                                                                            </div>
                                            <div class="box clearfix">
                                                <div class="text pull-left">
                                                    <h6>Nims Hospital<span>(1.22 km)</span></h6>
                                                </div>
                                                                                            </div-->
                                        </div>
                                    </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-lg-6 col-md-12 col-sm-12 column">
                                                <div class="form-group" style="position: relative; display: flex; align-items: center;">
                                                    <input type="text" name="date" placeholder="Tour Date" id="datepicker" style="padding-right: 30px; width: 100%; box-sizing: border-box; border: 1px solid #ccc; border-radius: 4px; height: 40px;">
                                                    <i class="far fa-calendar-alt" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); color: #aaa;"></i>
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-12 col-sm-12 column">
                                                <div class="form-group" style="position: relative; display: flex; align-items: center;">
                                                    <input type="text" name="time" placeholder="Any Time" style="padding-right: 30px; width: 100%; box-sizing: border-box; border: 1px solid #ccc; border-radius: 4px; height: 40px;">
                                                    <i class="far fa-clock" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%); color: #aaa;"></i>
                                                </div>
                                            </div>
                            ...
                            <div class="author-widget sidebar-widget">
                                ...
                                <div class="form-inner">
                                    <!--form action="property-details.html" method="post" class="default-form">
                                        ...
                                        <div class="form-group">
                                            <input type="email" name="email" placeholder="Your Email" style="height: 40px;" required="">
                                        </div>
                                        <div class="form-group">
