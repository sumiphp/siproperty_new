...
<body>
    ...
    <div class="boxed_wrapper">
                    ...
                    <div class="row align-items-center clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_2">
                                <div class="image-box">
                                    <figure class="image"><img class='ab' src="<?php echo base_url().'siproperty/assets/images/resource/about-1.jpg';?>" alt=""></figure>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div class="content_block_3">
                                <div class="content-box">
                                    <div class="sec-title">
                                        <h5>About</h5>
                                        <h2>Hi,  <?php echo str_replace('\\','',$aboutus->label1);?></h2>
                                    </div>
                                    <div class="text">
                                    ...
                                    <div class="btn-box">
                                        <a href="<?php echo base_url().'Home/contactUs';?>" class="theme-btn btn-one">Contact With Me</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                            <div class="funfact-block-one">
                                <div class="inner-box">
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="1500" data-stop="2350"><?php echo $homepagedetails2->yearofexperience;?></span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                            <div class="funfact-block-one">
                                <div class="inner-box">
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="1500" data-stop="2350"><?php echo $homepagedetails2->happyclients;?></span>
                                    </div>
                                    <p>Happy Clients</p>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                            <div class="funfact-block-one">
                                <div class="inner-box">
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="1500" data-stop="2350"><?php echo $homepagedetails2->completedprojects;?></span>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 funfact-block">
                            <div class="funfact-block-one">
                                <div class="inner-box">
                                    <div class="count-outer count-box">
                                        <span class="count-text" data-speed="1500" data-stop="2350"><?php echo $homepagedetails2->ongoingprojects;?></span>
                                    </div>
        ...
        <!--section class="download-section bg-color-3">
            <div class="pattern-layer" style="background-image: url(<?php //echo base_url().'siproperty/assets/images/shape/shape-3.png';?>);"></div>
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-6 col-md-6 col-sm-12 image-column">
                        <div class="image-box">
                            <figure class="image image-1 wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms"><img src="<?php echo base_url().'siproperty/assets/images/resource/download-1.png';?>" alt=""></figure>
                            <figure class="image image-2 wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms"><img src="<?php echo base_url().'siproperty/assets/images/resource/download-2.png';?>" alt=""></figure>
                        </div>
                    </div>
