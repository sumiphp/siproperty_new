                        ...
                        <div class="price-inner clearfix">
                            <ul class="category clearfix pull-left">
                                <li><a href="<?php echo base_url().'Home/contactUs';?>"><?php //echo $pd->project_status;
                                    ...
                                    //print_r($pd1);
                                    ?></a></li>
                                <li><a href="<?php echo base_url().'Home/contactUs';?>">For Details</a></li>
                            </ul>
                        ...
                        <div class="property-details-content">
                            <div class="carousel-inner">
                                <div class="single-item-carousel owl-carousel owl-theme owl-dots-none">
                                    <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/resource/property-details-1.jpg';?>" alt=""></figure>
                                    <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/resource/property-details-1.jpg';?>" alt=""></figure>
                                    <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/resource/property-details-1.jpg';?>" alt=""></figure>
                                </div>
                            </div>
                            ...
                            <div class="details-box content-widget">
                                ...
                                <ul class="list clearfix">
                                    ...
                                    <li>Garage Size: <span><?php echo $pd1->squarefeet;?></span></li>
                        ...
                        <div class="property-sidebar default-sidebar">
                            <div class="author-widget sidebar-widget">
                                <div class="author-box">
                                    <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/resource/author-1.jpg';?>" alt=""></figure>
                                    <div class="inner">
                                        <h4>SI Property</h4>
                                        <ul class="info clearfix">
