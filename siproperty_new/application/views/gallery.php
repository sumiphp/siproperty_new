...
<body>
    ...
    <div class="boxed_wrapper">
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="index.html"><span>Pages</span></a>
                                            <div class="megamenu">
        ...
        <!--Page Title-->
        <section class="page-title centred" style="background-image: url(<?php echo base_url().'siproperty/assets/images/background/page-title-4.jpg';?>);">
                    ...
                    <div class="items-container row clearfix">
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all real_estate architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="assets/images/gallery/gallery-1.jpg" alt=""></figure>
                                        <a href="assets/images/gallery/gallery-1.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all real_estate interior">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="assets/images/gallery/gallery-2.jpg" alt=""></figure>
                                        <a href="assets/images/gallery/gallery-2.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all interior architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="assets/images/gallery/gallery-3.jpg" alt=""></figure>
                                        <a href="assets/images/gallery/gallery-3.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8 col-md-6 col-sm-12 masonry-item small-column all real_estate architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="assets/images/gallery/gallery-4.jpg" alt=""></figure>
                                        <a href="assets/images/gallery/gallery-4.jpg" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="gallery-block-two">
                        <div class="inner-box">
                            <figure class="image-box">
                                <a href="assets/images/gallery/gallery-5.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/gallery-5.jpg" alt=""></a>
                            </figure>
                        </div>
                    </div>
                    <div class="gallery-block-two">
                        <div class="inner-box">
                            <figure class="image-box">
                                <a href="assets/images/gallery/gallery-6.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/gallery-6.jpg" alt=""></a>
                            </figure>
                        </div>
                    </div>
                    <div class="gallery-block-two">
                        <div class="inner-box">
                            <figure class="image-box">
                                <a href="assets/images/gallery/gallery-7.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/gallery-7.jpg" alt=""></a>
                            </figure>
                        </div>
                    </div>
                    <div class="gallery-block-two">
                        <div class="inner-box">
                            <figure class="image-box">
                                <a href="assets/images/gallery/gallery-8.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/gallery-8.jpg" alt=""></a>
                            </figure>
                        </div>
                    </div>
                    <div class="gallery-block-two">
                        <div class="inner-box">
                            <figure class="image-box">
                                <a href="assets/images/gallery/gallery-9.jpg" class="lightbox-image" data-fancybox="gallery"><img src="assets/images/gallery/gallery-9.jpg" alt=""></a>
                            </figure>
                        </div>
                    </div>
                    <div class="gallery-block-two">
                    ...
                    foreach($gallery as $gal){
                        ...
                        <!--div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all real_estate interior">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/gallery/gallery-11.jpg';?>" alt=""></figure>
                                        <a href="<?php echo base_url().'siproperty/assets/images/gallery/gallery-11.jpg';?>" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all interior architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/gallery/gallery-12.jpg';?>" alt=""></figure>
                                        <a href="<?php echo base_url().'siproperty/assets/images/gallery/gallery-12.jpg';?>" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all real_estate architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/gallery/gallery-13.jpg';?>" alt=""></figure>
                                        <a href="<?php echo base_url().'siproperty/assets/images/gallery/gallery-13.jpg';?>" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all interior architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/gallery/gallery-14.jpg';?>" alt=""></figure>
                                        <a href="<?php echo base_url().'siproperty/assets/images/gallery/gallery-14.jpg';?>" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12 masonry-item small-column all real_estate architechture">
                            <div class="gallery-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/gallery/gallery-15.jpg';?>" alt=""></figure>
                                        <a href="<?php echo base_url().'siproperty/assets/images/gallery/gallery-15.jpg';?>" class="lightbox-image" data-fancybox="gallery"><i class="icon-31"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div-->
