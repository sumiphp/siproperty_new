            ...
            <div class="auto-container">
                <div class="inner-box clearfix">
                    ...
                    <div class="btn-box">
                        ...
                        <a href="<?php echo base_url().'Home/propertylist';?>" class="theme-btn btn-one">CompletedProjects</a>
                    </div>
                </div>
            </div>
        </section>
                                            ...
                                            <div class="price-box clearfix">
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <img src="<?php echo base_url().'uploads/blog/'.$hp['picture'];?>" alt="">
                                                        <span><?php echo $hp['agent'];?></span>
                                                    </figure>
                                                </div>
                                            </div>
                                            <p><?php echo $hp['shortdesc'];?></p>
        ...
        <section class="clients-section bg-color-1">
            ...
            <div class="auto-container">
                ...
                foreach ($clients as $ct){?>
                                <li>
                                    <figure class="logo"><!--a href="#"--><img src="<?php echo base_url().'uploads/clients/'.$ct['image'];?>" alt=""><!--/a--></figure>
                                </li>
                                <?php } ?>
                                <!--li>
                                    <figure class="logo"><a href="index-2.html"><img src="<?php //echo base_url().'siproperty/assets/images/clients/clients-2.png';?>" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="<?php //echo base_url().'siproperty/assets/images/clients/clients-3.png';?>" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="<?php //echo base_url().'siproperty/assets/images/clients/clients-4.png';?>" alt=""></a></figure>
                                </li>
                                <li>
                                    <figure class="logo"><a href="index-2.html"><img src="<?php //echo base_url().'siproperty/assets/images/clients/clients-5.png';?>" alt=""></a></figure>
                                </li-->
                            </ul>
                        </div>
                    </div>
                ...
                <?php foreach($blog as $blg){?>
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="<?php echo base_url().'Home/blogdetails/'.$blg['blogid'];?>"><img src="<?php echo base_url().'uploads/blog/'.$blg['picture'];?>" alt="" class="imgftblg"></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
