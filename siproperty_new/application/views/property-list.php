...
?>
                ...
                foreach ($places as $pl){?>
                            ...
                            <div class="category-widget sidebar-widget">
                                ...
                                <ul class="category-list clearfix">
                                    <li><a href="<?php echo base_url().'Home/propertylist';?>">Ongoing Projects <span>(<?php //$this->db->where('amenityid',$am['amid']);
   ...
   //echo $this->db->last_query();
    ?>)</span></a></li>
                                    <li><a href="<?php echo base_url().'Home/propertylist';?>">Completed Projects <span>(<?php //$this->db->where('amenityid',$am['amid']);
