        ...
        <section class="cta-section alternate-2 centred" style="background-image: url(<?php echo base_url().'siproperty/assets/images/background/cta-1.jpg';?>);">
            <div class="auto-container">
                <div class="inner-box clearfix">
                    ...
                    <div class="btn-box">
                        <a href="<?php echo base_url().'Home/propertylist';?>" class="theme-btn btn-three">Ongoing Properties</a>
                        <a href="<?php echo base_url().'Home/propertylist';?>" class="theme-btn btn-one">Completed Properties</a>
                    </div>
                </div>
            </div>
        </section>
