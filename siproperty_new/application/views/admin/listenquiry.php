...
<div class="padding">
  ...
  <div class="box">
    ...
    <?php if ($this->session->flashdata('flash_msgeq')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgeq'); ?>
            </div>
        <?php endif; ?>
    <div class="row p-a">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t">
        ...
        ?>
            <tr id="row<?php echo $res['enquiryid'] ?>">
            <td><?php echo $i;?></td>
           ...
           <!--a href="<?php //echo base_url().'admin/editcarousel/'.$res['newsletterid'];?>"><button class="btn btn-success" >
            ...
            <!--button class="delete btn btn-danger" onclick="delrow(<?php //echo $res['enquiryid'];?>)">
                Delete
            </button-->

            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deleteenquiries/'.$res['enquiryid'];?>">
...
$.ajax({
            type:'GET',
            url: "<?php echo base_url().'Admin/deleteenquiries';?>",
            data:{id:id},
