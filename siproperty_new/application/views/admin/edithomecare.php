...
<div class="padding">
  ...
  <div class="p-x-xs">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='desc1' id='desc1' required ><?php echo $result->shortdesc;?></textarea>
      </div>
    </div>
...
$('#edit').on('submit', function (e) {
    ...
    // alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/edithcprocess';?>", // point to server-side controller method
            ...
            success: function (response) {
               ...
               window.location.href="<?php echo base_url().'Admin/listhomecare';?>";
            },
