  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box">
        ...
        <form action="<?= base_url('admin/addcarousalprocess'); ?>" method="post" enctype="multipart/form-data">
          <!--form id="addcarousal" role="form" class="mt-2" method="post" enctype="multipart/form-data"-->
            <div class="form-group">
              <label for="exampleInputEmail1">Enter title 1</label>
              <input type="text" class="form-control" placeholder="Enter title 1" id="title" name="title" required>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Enter title 2</label>
              <input type="text" class="form-control" placeholder="Enter title 2" id="title2" name="title2" required>
            </div>
...
<!-- endbuild -->
 <script>
$('#addcarousal').on('submit', function (e) {
    //e.preventDefault();
     alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/addcarousalprocess';?>", // point to server-side controller method
