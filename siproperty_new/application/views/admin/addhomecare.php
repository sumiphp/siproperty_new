...
<div class="padding">
  ...
  <form action="<?= base_url('admin/addhcprocess'); ?>" method="post" enctype="multipart/form-data">
  <div class="p-x-xs">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='desc1' id='desc1' required ></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='desc2' id='desc2' required ></textarea>
      </div>
    </div>
