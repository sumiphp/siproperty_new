      ...
      <table class="table table-striped b-t">
        ...
        ?>
            ...
            $imgpath="gallery";
             ?>
            <td>
            <img  style="height:8em; width:7em" src=<?php echo base_url().'uploads/homecare/'.$res['picture']?> >
            </td>
           <td>
           <a href="<?php echo base_url().'admin/edithomecare/'.$res['id'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            <!--button class="delete btn btn-danger"><a href="#" onclick="delrow(<?php //echo $res['id'];?>)">
                Delete
            </button-->
            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletehomecare/'.$res['id'];?>">
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'Admin/deletehomecare';?>",
            data:{id:id},
