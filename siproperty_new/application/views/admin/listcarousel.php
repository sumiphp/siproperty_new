...
<div class="padding">
  ...
  <div class="box">
    ...
    <?php if ($this->session->flashdata('flash_msgced')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgced'); ?>
            </div>
        <?php endif; ?>
    <div class="row p-a">
      ...
      <table class="table table-striped b-t">
        ...
        ?>
           ...
           <a href="<?php echo base_url().'admin/editcarousel/'.$res['id'];?>"><button class="btn btn-success" >
            ...
            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletecarousel/'.$res['id'];?>">
