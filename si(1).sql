...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 06, 2024 at 02:26 PM
...
INSERT INTO `home_projects` (`id`, `project_name`, `price`, `project_descripition`, `bedroom`, `bathroom`, `squarefeet`, `product_picture`, `status`, `project_status`, `time`, `emailid`, `phoneno`, `agent`, `addinside`, `shortdesc`, `picture`) VALUES
...
(2, 'fb112', 'twit11', 'you tube1', 'linked11', '1723800307settings.png', '1724156018settings.png', 'SI property has completed over 50 top-of-line projects making them one of the most trusted builders1', 'insta11', 'Pangode1', 'Trivandrum1', '944716 9988', 'pinterest', 'SI property has completed over 50 top-of-line projects making them one of the most trusted builders2');
...
--
ALTER TABLE `amenities`
  MODIFY `amid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
