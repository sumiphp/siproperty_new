...
//ini_set('display_errors', 1); 
	...
	function addfloor(){
		...
		$data['newsletter']=$this->sm->get_newsletter();
		$data['siteinf']=$this->sm->get_siteinf();*/
		$this->load->view('admin/addfloor',$data);
	...
	function editfloor(){
		...
		$this->load->model('Servicesmodel');
		$id=$this->uri->segment(3);
		$this->db2->where('floorid',$id);
		$this->db2->from('floors');
		$query = $this->db2->get();
		...
		$query = $this->db2->get();
		$data['result']=$query->result_array();
		$this->load->view('admin/editfloor',$data);
	...
	public function addreasonprocess(){
	 ...
	 //die;
		   ...
		   $this->session->set_flashdata('flash_msgre', 'Reason added Successfully');
		 ...
		 $alttag1=$this->input->post('alttag1');*/
		  ...
		  $data = array(
		   ...
		   $this->db2->where('id',$id);
				 ...
				 $this->session->set_flashdata('flash_msger', 'Reason edited Successfully');
...
public function deleteenquiries(){
	...
	$this->session->set_flashdata('flash_msgeq', 'Deleted Successfully');
...
public function editcontactusprocess(){
	...
	if (($image1!='') && ($image2=='')){
	  ...
	  $this->session->set_flashdata('flash_msgcs', 'Updated Successfully');
  ...
  /* $file_ext = pathinfo($_FILES["image1"]["name"],PATHINFO_EXTENSION);
   ...
   $new_name3 = time().'aboutus3'.'.'.$file_ext;
	...
	if (($image1!='') && ($image2=='')){
	  ...
	  ($this->db2->affected_rows() != 1) ? $this->session->set_flashdata('flash_msgab', 'Error in Editing About Us') : $this->session->set_flashdata('flash_msgab', 'About Us Edited Successfully');
...
public function edithomeprocess(){
   ...
   //$newfile_name= preg_replace('/[^A-Za-z0-9]/', "", $file_name);
   //$//ext=pathinfo($_FILES["file"]["name"], PATHINFO_EXTENSION);
   $new_name = time().'homepage'.'.'.$file_ext;
   $config['file_name'] = $new_name;
   $config['upload_path'] = 'uploads/homepage';
   $config['allowed_types'] = 'gif|jpg|png|jpeg';	
   //$config['max_size'] = '1024'; //1 MB
   ...
   if (($_FILES['image1']['name'])!='') {
	   if (0 < $_FILES['image1']['error']) {
		   ...
		   if (file_exists('uploads/homepage/'.$new_name)) {
   ...
   $new_name3 = time().'aboutus3'.'.'.$file_ext;
	...
	if (($image1!='') && ($image2=='')){
	 ...
	 $designation=$this->input->post('designation');
	  ...
	  $this->session->set_flashdata('flash_msghm', 'Edited Successfully');
   ...
   $config['file_name'] = $new_name;
	...
	//$alttag1=$this->input->post('alttag1');
	 ...
	 $data = array(
	  ...
	  $this->session->set_flashdata('flash_msgte', 'Testimonial added Successfully');
...
public function addhcprocess(){
   ...
   $config['file_name'] = $new_name;
	...
	$data = array(
	 ...
	 $this->session->set_flashdata('flash_msghc', 'Homecare added Successfully');
...
public function addserprocess(){
   ...
   $config['file_name'] = $new_name;
	...
	if (isset($_FILES['image1']['name'])) {
		if (0 < $_FILES['image1']['error']) {
			...
			if (file_exists('uploads/services/' .$new_name)) {
				echo 'File already exists : uploads/services/' .$new_name;
			} else {
	...
	$data = array(
	   'name'=>"$title",
		//'servicedesc' =>"$content2",
		'servicedesc' =>"$content1",
		//'name'=>"$name",
		//'picture'=>$image1,
		//'designation'=>$designation,
		//'date'=>$date,
	 ...
	 $this->session->set_flashdata('flash_msghc', 'Services added Successfully');

	 redirect("admin/addservices");
...
public function addfaqprocess(){
   ...
   $config['file_name'] = $new_name;
	...
	$data = array(
	 ...
	 $this->session->set_flashdata('flash_msghc', 'Faq added Successfully');
...
public function edithcprocess(){
   ...
   if (isset($_FILES['image1']['name'])) {
	...
	$this->session->set_flashdata('flash_msghc', 'Edited Successfully');
...
public function editserprocess(){
...
public function edittestimonialsprocess(){
   ...
   $file_ext = pathinfo($_FILES["image1"]["name"],PATHINFO_EXTENSION);
	...
	if (($_FILES['image1']['name'])!='') {
		$file_ext = pathinfo($_FILES["image1"]["name"],PATHINFO_EXTENSION);
		$new_name1 = time().'testimonial.'.$file_ext;
		 $config['file_name'] = $new_name1;
		 $config['upload_path'] = 'uploads/testimonial';
		 $config['allowed_types'] = 'gif|jpg|png|jpeg';	
		 $config['max_size'] = '1024'; //1 MB
		 ...
		 if (isset($_FILES['image1']['name'])) {
			 if (0 < $_FILES['image1']['error']) {
				 ...
				 if (file_exists('uploads/testimonial/'.$new_name1)) {
					 echo 'File already exists : uploads/testimonial/'.$new_name1;
				 } else {
...
//die;
	 ...
	 echo ($this->db2->affected_rows() != 1) ? $this->session->set_flashdata('flash_msgte', 'Error in Editing Testimonials') : $this->session->set_flashdata('flash_msgte', 'Testimonials Edited Successfully');
...
public function viewprojectdetails(){
    ...
    $data['fl']=$query->result_array();

	//$this->db2->where('projectid',$id);
	$this->db2->from('amenities');
    $query = $this->db2->get();

    $data['amn']=$query->result_array();
...
public function addhomecare(){
	...
	$this->db2->from('homecare');
    $query = $this->db2->get();
	$this->load->view('admin/addhomecare');
...
public function addprojectprocess(){
	...
	$project_data = array(
		...
		'noofgarage'=> $this->input->post('noofgarage'),
    ...
    if ($this->Servicesmodel->add_project($project_data)) {
        ...
        $this->session->set_flashdata('messageap', 'Project added successfully.');
            redirect('admin/addproject'); 
    } else {
        // Handle failure (e.g., show an error message)
		$this->session->set_flashdata('errorap', 'Failed to add project.');
		redirect('admin/addproject');
    }
}
...
$prjdt=join(",",$pic);
	...
	$project_data = array(
		...
		'prjlocation'=> $this->input->post('prjlocation'),
		'amenities'=> join(',',$this->input->post('amenities')),
		...
		'thirdfloordescp1'=> $image3,'otherpictures'=>$prjdt
	...
	for($i=1;$i<=$tot;$i++){
		$floorname=$this->input->post('nm'.$i);
		$floordesc=$this->input->post('desc'.$i);


		$file_ext = pathinfo($_FILES["fl.$i"]["name"],PATHINFO_EXTENSION);
		//$file_name=$_FILES['image1']['name'];
		//$newfile_name= preg_replace('/[^A-Za-z0-9]/', "", $file_name);
		//$//ext=pathinfo($_FILES["file"]["name"], PATHINFO_EXTENSION);
		$fname=$new_name.$i;
		$fname = time().'project'.'.'.$file_ext;
		...
		if (($_FILES["$fname"]['name'])!='') {
			if (0 < $_FILES["$fname"]['error']) {
				echo 'Error during file upload' . $_FILES["$fname"]['error'];
			} else {
				if (file_exists('uploads/project/'.$fname)) {
					//echo 'File already exists : uploads/contactus/'.$new_name;
					$image3=$image33;
				} else {
		...
		$data = array('picture' =>$image3,
			'floorname' => $floorname,
			'floordesc' => $floordesc,'projectid'=>$id);
			if ($floorname!=''){
		$this->Servicesmodel->update_floordt($id,$data);
			}

	}

    if ($this->Servicesmodel->update_projectdt($id,$project_data,$prjdt)) {
...
public function editprojectprocess(){
    ...
    if ($this->Servicesmodel->update_project($id,$project_data)) {
        // Handle success (e.g., redirect or show a success message)
        $this->session->set_flashdata('messageep', 'Project Edited successfully.');
            redirect('admin/listongoingprojects'); 
    } else {
        // Handle failure (e.g., show an error message)
		$this->session->set_flashdata('error', 'Failed to Edit project.');
...
public function deleteprojects(){
	...
	$this->db2->where('projectid',$id);
	$this->db2->delete('projectdetails');
...
public function deletesubscribers(){
	...
	$this->session->set_flashdata('flash_msgsub', 'Deleted Successfully');
...
public function deletegallery(){
	...
	$this->session->set_flashdata('flash_msgge', 'Deleted Successfully');
...
public function addblogprocess(){
	...
	$longdesc2=$this->input->post('longdesc2');
	$longdescq=$this->input->post('longdescq');
	//  $title4=$this->input->post('title4');
	...
	//  $showinfront=$this->input->post('showinfront');
	 ...
	 $data = array(
		...
		//  'alttagimg1'=>"$alttag1",
		'active'=>"$status",
		'blogdesc2'=>$longdesc2,'quotedesc'=>$longdescq,'picture2'=>$image2	
	  );
	//print_r($data);
	//die;
	  $id=$this->uri->segment(3); 
	  ...
	  $this->session->set_flashdata('flash_msgbg', 'Blog added Successfully');
...
public function addfloorprocess(){
	...
	//die;
	  ...
	  //$this->db2->where('testimonialid',$id);
	   ...
	   $this->db2->insert('floors', $data);
	  //echo $this->db2->last_query();
	   //die;
	  //echo ($this->db2->affected_rows() != 1) ? 'Error in Adding Blog' : '<b>Blog Added Successfully</b>';
	  $this->session->set_flashdata('flash_msgfl', 'Floor added Successfully');
	  redirect("admin/addfloor");
...
$title=$this->input->post('title');
	...
	//  $showinfront=$this->input->post('showinfront');
	 ...
	 $data = array(
	  ...
	  $this->session->set_flashdata('flash_msgcad', 'Carousel added Successfully');
   ...
   $image11=$imgdetails->picture;
	...
	//$link=$this->input->post('link');
	 ...
	 $data = array(
	  ...
	  $this->session->set_flashdata('flash_msgced', 'Carousel edited Successfully');
	...
	//$link=$this->input->post('link');
	 ...
	 $data = array(
	  ...
	  //$this->db2->where('testimonialid',$id);
	   ...
	   $this->session->set_flashdata('flash_msgga', 'Gallery added Successfully');
	   //echo $this->db2->last_query();
//die;
...
public function editgalleryprocess(){
   ...
   //$link=$this->input->post('link');
	...
	$data = array(
	  ...
	  $this->session->set_flashdata('flash_msgge', 'Gallery edited Successfully');
	  redirect("admin/listgallery");
...
public function editcatprocess(){
   ...
   //$newfile_name= preg_replace('/[^A-Za-z0-9]/', "", $file_name);
   //$//ext=pathinfo($_FILES["file"]["name"], PATHINFO_EXTENSION);
   $new_name = time().'category'.'.'.$file_ext;
   $config['file_name'] = $new_name;
   ...
   if (isset($_FILES['image1']['name'])) {
	   if (0 < $_FILES['image1']['error']) {
		   ...
		   if (file_exists('uploads/category/'.$new_name)) {
			   //echo 'File already exists : uploads/contactus/'.$new_name;
			   $image1=$image11;
		   } else {
   ...
   //$link=$this->input->post('link');
	...
	$data = array(
	  ...
	  $this->db2->where('cat_id',$id);
	   ...
	   //$this->db2->insert('productimages', $data);
	  //echo ($this->db2->affected_rows() != 1) ? 'Error in Adding Picture' : '<b>Picture Added Successfully</b>';
	  $this->session->set_flashdata('flash_msgge', 'Category edited Successfully');
...
public function editfloorprocess(){
...
//die;
	   ...
	   //$this->db2->insert('productimages', $data);
	  //echo ($this->db2->affected_rows() != 1) ? 'Error in Adding Picture' : '<b>Picture Added Successfully</b>';
	  $this->session->set_flashdata('flash_msgfl', 'Floor edited Successfully');
	  redirect("admin/listfloor");
...
public function listservices(){
	...
	$this->load->model('Servicesmodel');
	$config = array();
	$config["base_url"] = base_url() . "admin/listservices";
	//$config["total_rows"] = $this->sm->get_countsolutions();
	//$config["total_rows"]=$this->sm->get_countfeatureupdate();
	$config["total_rows"]=$this->sm->get_countdata('services');
	$config["per_page"] = 10;
	$config["uri_segment"] = 3;
    ...
    //$query = $this->db2->get();
    //$data['resultphone']=$query->row();
	$data['result']=$this->sm->get_data($config["per_page"], $page,'services');	
	//$data['contactus']=$this->sm->get_contactus();
	//$data['newsletter']=$this->sm->get_newsletter();
	//$data['siteinf']=$this->sm->get_siteinf();	
	$this->load->view('admin/listservices',$data);
}
...
public function listfaq(){
	...
	$this->load->model('Servicesmodel');
	$config = array();
	$config["base_url"] = base_url() . "admin/listfaq";
	//$config["total_rows"] = $this->sm->get_countsolutions();
	//$config["total_rows"]=$this->sm->get_countfeatureupdate();
	$config["total_rows"]=$this->sm->get_countdata('faq');
	$config["per_page"] = 10;
	$config["uri_segment"] = 3;
	$config['full_tag_open'] = '<ul class="pagination">';
    $config['full_tag_close'] = '</ul>';
    ...
    //$query = $this->db2->get();
    //$data['resultphone']=$query->row();
	$data['result']=$this->sm->get_data($config["per_page"], $page,'faq');	
	//$data['contactus']=$this->sm->get_contactus();
	//$data['newsletter']=$this->sm->get_newsletter();
	//$data['siteinf']=$this->sm->get_siteinf();	
 ...
 if (($_FILES["image2"]["name"])!=''){
	...
	$data = array(
	   ...
	   'linkedlink'=>"$linkedlink",
		'favicon'=>$image2,
		'logo'=>"$image1",'footercontent'=>"$desc",'footercontent2'=>"$desc2"		
	 );
	 //print_r($data);
	 //$id=$this->uri->segment(3); 
	 $id=$this->input->post('id');
	 ...
	 ($this->db2->affected_rows() != 1) ? $this->session->set_flashdata('flash_msgst', 'Error in Settings') : $this->session->set_flashdata('flash_msgst', 'Settings Edited Successfully');
...
public function deletefaq(){
	...
	redirect("admin/listfaq");
		...
		public function deletereason(){
			...
			public function listfloor(){
				...
				$this->load->model('Servicesmodel');
				$config = array();
				$config["base_url"] = base_url() . "Admin/listfloor";
				//$config["total_rows"] = $this->sm->get_countsolutions();
				//$config["total_rows"]=$this->sm->get_countfeatureupdate();
				$config["total_rows"]=$this->sm->get_countdata('floors');
				$config["per_page"] = 5;
				$config["uri_segment"] = 3;
				$config['full_tag_open'] = '<ul class="pagination">';
    $config['full_tag_close'] = '</ul>';
    ...
    $config['num_tag_close'] = '</li>';
				...
				//$query = $this->db2->get();
				//$data['resultphone']=$query->row();
				$data['result']=$this->sm->get_data($config["per_page"],$page,'floors');	
				//$data['contactus']=$this->sm->get_contactus();
				//$data['newsletter']=$this->sm->get_newsletter();
				//$data['siteinf']=$this->sm->get_siteinf();	
				$this->load->view('admin/listfloor',$data);
			}
...
public function addcatprocess(){
	...
	if (isset($_FILES['image1']['name'])) {
		if (0 < $_FILES['image1']['error']) {
			...
			if (file_exists('uploads/category' . $_FILES['image1']['name'])) {
				echo 'File already exists : uploads/category' . $_FILES['image1']['name'];
			} else {
	...
	//$link=$this->input->post('link');
	 ...
	 $data = array(
	  ...
	  //$this->db2->where('testimonialid',$id);
	   ...
	   $this->session->set_flashdata('flash_msgga', 'Category added Successfully');
	   //echo $this->db2->last_query();
//die;
	  //echo ($this->db2->affected_rows() != 1) ? 'Error in Adding gallery' : '<b>Gallery Added Successfully</b>';
	...
	public function listcat(){
		...
		$this->load->model('Servicesmodel');
		$config = array();
		$config["base_url"] = base_url() . "Admin/listcat";
		//$config["total_rows"] = $this->sm->get_countsolutions();
		//$config["total_rows"]=$this->sm->get_countfeatureupdate();
		$config["total_rows"]=$this->sm->get_countdata('category');
		$config["per_page"] = 10;
		$config["uri_segment"] = 3;
		$config['full_tag_open'] = '<ul class="pagination">';
    $config['full_tag_close'] = '</ul>';
    ...
    $config['num_tag_close'] = '</li>';
		...
		//$query = $this->db2->get();
		//$data['resultphone']=$query->row();
		$data['result']=$this->sm->get_data($config["per_page"], $page,'category');	
		//$data['contactus']=$this->sm->get_contactus();
		//$data['newsletter']=$this->sm->get_newsletter();
		//$data['siteinf']=$this->sm->get_siteinf();	
