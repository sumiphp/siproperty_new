...
class Home extends CI_Controller {
    ...
    $config['num_tag_close'] = '</li>';
        ...
        $this->data['homeprojectscar']=$this->frontend->get_propertylistcar();
        //print_r($this->data['homeprojectscar']);
...
$config['num_tag_close'] = '</li>';
    ...
    if ($this->input->post('search')!=''){
        ...
        $flag=2;
        $ser=$this->input->post('loc');
    }
    else if ($this->input->post('typ')!=''){
        $flag=3;
        $ser=$this->input->post('typ');
    }
    $this->data['homeprojects']=$this->frontend->get_propertylistser($config["per_page"],$page,$ser,$flag);
    $this->data['places']=$this->frontend->get_placesactive();
$this->data['ser']=1;
...
$config['num_tag_close'] = '</li>';
	...
	$page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
	$this->data["links"] = $this->pagination->create_links();
	$this->data['homeprojects']=$this->frontend->get_propertylisttype($config["per_page"],$page,$type,$loc);
    $this->data['ame']=$this->frontend->get_amlist();
    $this->data['places']=$this->frontend->get_placesactive();
    $this->load->view('property-list.php',$this->data);
}
...
public function propertylistloc(){
    $blog_slug='';
    $this->data['contactus'] = $this->frontend->getcontactus($blog_slug);
    $this->data['blog'] = $this->frontend->getBlogs($blog_slug);
    $this->data['settings']= $this->frontend->settings();
    ...
    $config = array();
	$config["base_url"] = base_url() . "Home/propertylistloc";
	//$config["total_rows"] = $this->sm->get_countsolutions();
    $type=$this->uri->segment(3);
	$config["total_rows"]=$this->frontend->get_countpropertylistloc($type);
	$config["per_page"] = 3;
	$config["uri_segment"] = 3;
    $config['full_tag_open'] = '<ul class="pagination">';
$config['full_tag_close'] = '</ul>';
...
$config['num_tag_close'] = '</li>';
	...
	$page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
	$this->data["links"] = $this->pagination->create_links();
	$this->data['homeprojects']=$this->frontend->get_propertylistloc($config["per_page"],$page,$type);
    $this->data['ame']=$this->frontend->get_amlist();
    $this->data['places']=$this->frontend->get_placesactive();
    $this->load->view('property-list.php',$this->data);
}
...
public function propertyliston(){
    $blog_slug='';
    $this->data['contactus'] = $this->frontend->getcontactus($blog_slug);
    $this->data['blog'] = $this->frontend->getBlogs($blog_slug);
    $this->data['settings']= $this->frontend->settings();
    ...
    $config = array();
	$config["base_url"] = base_url() . "Home/propertyliston";
	//$config["total_rows"] = $this->sm->get_countsolutions();
	$config["total_rows"]=$this->frontend->get_countpropertyliston();
	$config["per_page"] = 3;
	$config["uri_segment"] = 3;
    $config['full_tag_open'] = '<ul class="pagination">';
$config['full_tag_close'] = '</ul>';
...
$config['num_tag_close'] = '</li>';
	...
	$page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
	$this->data["links"] = $this->pagination->create_links();
	$this->data['homeprojects']=$this->frontend->get_propertyliston($config["per_page"],$page);
    $this->data['ame']=$this->frontend->get_amlist();
    $this->data['places']=$this->frontend->get_placesactive();
    $this->load->view('property-list.php',$this->data);
}
...
public function propertylistcomp(){
    $blog_slug='';
    $this->data['contactus'] = $this->frontend->getcontactus($blog_slug);
    $this->data['blog'] = $this->frontend->getBlogs($blog_slug);
    $this->data['settings']= $this->frontend->settings();
    ...
    $config = array();
	$config["base_url"] = base_url() . "Home/propertylistcomp";
	//$config["total_rows"] = $this->sm->get_countsolutions();
	$config["total_rows"]=$this->frontend->get_countpropertylistcomp();
	$config["per_page"] = 3;
	$config["uri_segment"] = 3;
    $config['full_tag_open'] = '<ul class="pagination">';
$config['full_tag_close'] = '</ul>';
...
$config['num_tag_close'] = '</li>';
	...
	$page = ($this->uri->segment(3)) ? $this->uri->segment(3) : 0;
	$this->data["links"] = $this->pagination->create_links();
	$this->data['homeprojects']=$this->frontend->get_propertylistcomp($config["per_page"],$page);
    $this->data['ame']=$this->frontend->get_amlist();
    $this->data['places']=$this->frontend->get_placesactive();
    $this->load->view('property-list.php',$this->data);
}
