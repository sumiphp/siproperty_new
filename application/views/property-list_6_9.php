    ...
    <div class="boxed_wrapper">
        ...
        <section class="page-title-two bg-color-1 centred">
            <div class="pattern-layer">
                <div class="pattern-1" style="background-image: url(<?php echo base_url().'siproperty/assets/images/shape/shape-9.png';?>);"></div>
                <div class="pattern-2" style="background-image: url(<?php echo base_url().'siproperty/assets/images/shape/shape-10.png';?>);"></div>
            </div>
...
?>
                                ...
                                <div class="widget-content">
                                    <div class="select-box">
                                        <select class="type" onchange="filt(this.value)" name="typ" >
                                    ...
                                    <div class="select-box">
                                        <select class="wide" onchange="filt1(this.value)" name="loc" >
                ...
                foreach ($places as $pl){?>
                            ...
                            <div class="category-widget sidebar-widget">
                                ...
                                <ul class="category-list clearfix">
                                    <li><a href="<?php echo base_url().'Home/propertyliston';?>">Ongoing Projects <span>(<?php //$this->db->where('amenityid',$am['amid']);
   ...
   //echo $this->db->last_query();
    ?>)</span></a></li>
                                    <li><a href="<?php echo base_url().'Home/propertylistcomp';?>">Completed Projects <span>(<?php //$this->db->where('amenityid',$am['amid']);
...
?>
 <li><a href="<?php echo base_url().'Home/propertylist';?>"><?php echo $am['amenities'];?> <span>
 <?php $this->db->where('amenityid',$am['amid']);
 ...
 <?php } ?>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="property-content-side">
                            <div class="item-shorting clearfix">
                                <div class="left-column pull-left">
                                    <h5>Search Results: <span>Showing 1-5 of 20 Listings</span></h5>
                                </div>
                            ...
                            <div class="wrapper list">
                                <div class="deals-list-content list-item">
                                    ...
                                    <div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img class='prp' src="<?php echo base_url().'uploads/project/'.$hp['product_picture'];?>" alt=""></figure>
                                                <div class="batch"><i class="icon-11"></i></div>
                                                <span class="category">
    ...
    echo $locdt->prjlocation;
                                        ...
                                        <li><i class="icon-16"></i><?php echo $hp['squarefeet'];?> Sq Ft</li>
                                                ...
                                                <div class="other-info-box clearfix">
                                                    <div class="btn-box pull-left"><a href="<?php echo base_url().'Home/'.'propertydetails';?>/<?php echo $hp['id'];?>" class="theme-btn btn-two">See Details</a></div>
                                                    <ul class="other-option pull-right clearfix">
                                                        <li><a href="<?php echo base_url().'Home/'.'propertydetails';?>/<?php echo $hp['id'];?>"><i class="icon-12"></i></a></li>
                                                        <li><a href="<?php echo base_url().'Home/'.'propertydetails';?>/<?php echo $hp['id'];?>"><i class="icon-13"></i></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
...
<?php } ?>
                                    ...
                                    <!--div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/resource/deals-5.jpg';?>" alt=""></figure>
                                                <div class="batch"><i class="icon-11"></i></div>
                                                <span class="category">Featured</span>
                                                <div class="buy-btn"><a href="property-details.html">For Buy</a></div>
                                            </div>
                                    ...
                                    <div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/resource/deals-6.jpg';?>" alt=""></figure>
                                                <div class="batch"><i class="icon-11"></i></div>
                                                <span class="category">Featured</span>
                                                <div class="buy-btn"><a href="property-details.html">For Buy</a></div>
                                            </div>
                                    ...
                                    <div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/resource/deals-7.jpg';?>" alt=""></figure>
                                                <div class="batch"><i class="icon-11"></i></div>
                                                <span class="category">Featured</span>
                                                <div class="buy-btn"><a href="property-details.html">For Buy</a></div>
                                            </div>
                                    ...
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/feature/feature-4.jpg';?>" alt=""></figure>
                                                        <div class="batch"><i class="icon-11"></i></div>
                                                        <span class="category">Featured</span>
                                                    </div>
                                                    <div class="lower-content">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/feature/feature-5.jpg';?>" alt=""></figure>
                                                        <div class="batch"><i class="icon-11"></i></div>
                                                        <span class="category">Featured</span>
                                                    </div>
                                                    <div class="lower-content">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 feature-block">
                                            <div class="feature-block-one">
                                                <div class="inner-box">
                                                    <div class="image-box">
                                                        <figure class="image"><img src="<?php //echo base_url().'siproperty/assets/images/feature/feature-6.jpg';?>" alt=""></figure>
                                                        <div class="batch"><i class="icon-11"></i></div>
                                                        <span class="category">Featured</span>
                                                    </div>
                                                    <div class="lower-content">
...
function filt(val){
    ...
    window.location.href ="<?php echo base_url().'Home/propertylisttype';?>/"+val;
...
window.location.href ="<?php echo base_url().'Home/propertylistloc';?>/"+val;
