                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div class="default-sidebar property-sidebar">
                            <div class="filter-widget sidebar-widget">
                                ...
                                <form method='post' action="<?php echo base_url().'Home/propertylisttype';?>" id="frmfil" >
                                <div class="widget-content1">
                                    <div class="select-box">
                                    <!--select class="type" onchange="filt(this.value)" name="typ"-->
                                    <select class="wide1" name="typ" required>
                                    ...
                                    <select class="wide1" name="loc" required>
                                           <option value="">Select Location</option>
                                           <?php 
                //print_r($clients);
                
                foreach ($places as $pl){?>
                                           <option value="<?php echo $pl['prjlocation'];?>" <?php if ($seg1
                                           ==$pl['prjlocation']){?> selected <?php }?>><?php echo $pl['prjlocation'];?></option>
                                           <?php } ?>
...
?>
 ...
 <?php } ?>
                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="property-content-side">
                            <div class="item-shorting clearfix">
                                <div class="left-column pull-left">
                                    <h5>Search Results: <span>Showing 1-5 of 10 Listings</span></h5>
                                </div>
                                    ...
                                    <div class="deals-block-one">
                                        <div class="inner-box">
                                            <div class="image-box">
                                                ...
                                                <span class="category"><?php //echo $hp['agent'];
    ...
    //echo $locdt->prjlocation;
                                                            ...
                                                            ?></span>
                                                <!--div class="buy-btn"><a href="tel:<?php //echo $contactus->phoneno;?>">Call Now</a></div-->
                                            </div>
    ...
    echo $locdt->prjlocation;
                                                            ...
                                                            ?>,<br><?php echo $locdt->propertytype;?></h6>
                                                        </figure>
                                                    </div>
                                                </div>
