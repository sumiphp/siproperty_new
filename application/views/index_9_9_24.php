...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <section class="deals-style-two sec-pad" style="padding-bottom:0px !important">
            <div class="auto-container">
                <div class="sec-title">
                <?php if ($ser==1){?>
                    <h5>Properties</h5>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    ...
                                    <span class="category"><?php //echo $pd->project_status;
                                    //echo $ser;
                                    ...
                                    //print_r($pd1);
                                    ?></span>
                                    <!--div class="buy-btn"><a href="<?php //echo base_url().'Home/propertydetails';?>"></a></div-->
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
    ...
    //echo $locdt->prjlocation;
                                        ...
                                        <li><i class="icon-16"></i><?php echo $hp['squarefeet'];?> Sq Ft</li>
                                            ...
                                            <div class="other-info-box clearfix">
                                                ...
                                                <?php if ($ser==1){?>
                                                    <li><?php $this->db->where('projectid',$hp['id']);
    //$this->db->where('status',0);
    $this->db->select('*');
    $this->db->from('projectdetails');
    $query = $this->db->get();
    ...
    $locdt=$query->row();
    echo $locdt->prjlocation;?>&nbsp;,</li>
                                                    <li><?php echo $locdt->propertytype;?></li>
                                                    <?php } ?>
                                                </ul>
                                            </div>
                                        </div>
    ...
    echo $locdt->prjlocation;
                                    ...
                                    <div class="buy-btn pull-right"><a href="tel:<?php echo $contactus->phoneno;?>">Call Now</a></div>
                                </div>
                ...
                <?php foreach($blog as $blg){?>
                    <div class="single-item">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="deals-block-one">
                                    <div class="inner-box">
                                        ...
                                        <div class="lower-content">
                                            <div class="title-text"><h4><a href="<?php echo base_url().'Home/blogdetails/'.$blg['blogid'];?>"><?php echo $blg['blogtitle'];?></a></h4></div>
                                            <div class="price-box clearfix">
                                                <div class="price-info pull-left">
                                                    <h6>Posted On</h6>
                                                    <h4><?php 
                                        ...
                                        echo $month = date('d',strtotime($date));?> <?php echo $month = date('M',strtotime($date));?>, <?php echo $datedt[0];?></h4>
                                                </div>
                                                <ul class="other-option pull-right clearfix">
                                                    <!--li><a href="<?php //echo base_url().'Home/blogdetails/'.$blg['blogid'];?>"><i class="icon-12"></i></a></li>
                                                    <li><a href="<?php //echo base_url().'Home/blogdetails/'.$blg['blogid'];?>"><i class="icon-13"></i></a></li-->
                                                </ul>
                                            </div>
                                            ...
                                            <div class="btn-box"><a href="<?php echo base_url().'Home/blogdetails/'.$blg['blogid'];?>" class="theme-btn btn-one">See Details</a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo base_url().'uploads/blog/'.$blg['frontpicture'];?>" alt="" class="imgftblg"></figure>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="deals-block-one">
                                    <div class="inner-box">
                                        <div class="batch"><i class="icon-11"></i></div>
                                        <span class="category">Featured2</span>
                                        <div class="lower-content">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/resource/deals-1.jpg';?>" alt=""></figure>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="deals-block-one">
                                    <div class="inner-box">
                                        <div class="batch"><i class="icon-11"></i></div>
                                        <span class="category">Featured3</span>
                                        <div class="lower-content">
