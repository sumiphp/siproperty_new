...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!--Page Title-->
        <section class="page-title centred" style="background-image: url(<?php echo base_url().'siproperty/assets/images/background/page-title-3.jpg';?>);">
                            ...
                            <div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        ...
                                        <span class="designation"><?php echo $test['designation'];?>
                                    </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <div class="inner">
                                        <h4><a href="agents-details.html"><?php echo $ag['name'];?></a></h4>
        ...
        <section class="feature-section sec-pad">
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <h2>Ongoing Properties</h2>
                    <p>We are pioneers in building feature-rich apartment projects that come within your budget <br />our homes are the beacon of hope, dreams, and happiness.</p>
                </div>
                <div class="row clearfix">
                ...
                foreach($homeprojects as $hp){
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 feature-block">
                        <div class="feature-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo base_url().'uploads/project/'.$hp['product_picture'];?>" alt="" class='prp' ></figure>
