...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!--Page Title-->
        <section class="page-title centred" style="background-image: url(<?php echo base_url().'siproperty/assets/images/background/page-title.jpg';?>);">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <h4>Email Address</h4>
                                <p><a href="mailto:<?php echo $contactus->emailid;?>"><?php echo $contactus->emailid;?></a><br /><a href="mailto:<?php echo $contactus->emailid2;?>"><?php echo $contactus->emailid2;?></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <h4>Phone Number</h4>
                                <p><a href="tel:+<?php echo $contactus->phoneno;?>">+<?php echo $contactus->phoneno;?></a><br /><a href="tel:+<?php echo $contactus->phoneno1;?>">+<?php echo $contactus->phoneno1;?></a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 info-block">
                        <div class="info-block-one">
                            <div class="inner-box">
                                ...
                                <p><?php echo $contactus->location;?>, <br /><?php echo $contactus->pinno;?></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="contact-section bg-color-1">
            <div class="auto-container">
                <div class="row align-items-center clearfix">
                    <div class="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div class="content-box">
                            ...
                            <span id='msg' style='color:green;font-weight:bold;'></span>
                                <form method="post" id="frmcontact"  action="<?php echo base_url().'Home/contactusprocess';?>"> 
                                    <div class="row clearfix">
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <input type="text" name="name" placeholder="Your Name" required="" class='frm'>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                                            <input type="email" name="email" placeholder="Email address" required="" class='frm'>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 form-group">
                    ...
                    <iframe 
                                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3945.9280327351375!2d76.98550957406161!3d8.506368896952841!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3b05bb38f83f4539%3A0x49bae54b857068b6!2sSI%20Property%20Leela%20Madhavam%20Legacy!5e0!3m2!1sen!2sin!4v1720869589602!5m2!1sen!2sin<?php //echo $pd->gmapurl;?>" 
                                            width="600" 
                                            height="450" 
                                            style="border:0;" 
                                            allowfullscreen="" 
                        ...
                        <!--div class="google-map-area">
                            <div 
                                ...
                                data-icon-path="https://www.google.com/maps?q=Silver+Oaks,+Near+Golf+Club,+Kowdiar,+Trivandrum,+Kerala,+India<?php //echo base_url().'siproperty/assets/images/icons/map-marker.png';?>"  
                                data-map-title="Brooklyn, New York, United Kingdom" 
                                data-map-zoom="12" 
                                data-markers='{
                                    "marker-1": [40.712776, -74.005974, "<h4>Branch Office</h4><p>77/99 New York</p>","<?php echo base_url().'siproperty//images/icons/map-marker.png';?>"]
                                }'>
