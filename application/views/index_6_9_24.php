...
<body>
    ...
    <div class="boxed_wrapper">
        ...
        <!--header class="main-header header-style-two">
            ...
            <div class="header-lower">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="<?php echo base_url().'siproperty/assets/images/logo-light.png';?>" alt=""></a></figure>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-md navbar-light">
                                <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="<?php echo base_url().'Home/contactUs';?>"><span>Projects</span></a></li>   
            ...
            <div class="sticky-header">
                <div class="outer-box">
                    <div class="main-box">
                        <div class="logo-box">
                            <figure class="logo"><a href="index.html"><img src="<?php echo base_url().'siproperty/assets/images/logo.png';?>" alt=""></a></figure>
                        </div>
                        <div class="menu-area clearfix">
        ...
        <div class="mobile-menu">
            ...
            <nav class="menu-box">
                <div class="nav-logo"><a href="index.html"><img src="<?php echo base_url().'siproperty/assets/images/logo-2.png';?>" alt="" title=""></a></div>
        ...
        <section class="banner-style-two centred">
            ...
            //print_r($carousel);
               foreach($carousel as $car){?>
                <div class="slide-item">
                    ...
                    <div class="auto-container">
                        <div class="content-box">
                            <h2><?php echo $car['maintitle'];?></h2>
                            <p><?php echo $car['subtitle'];?></p>
                        </div> 
                    </div>
                </div><?php }?>
                <!--div class="slide-item">
                    <div class="image-layer" style="background-image:url(<?php //echo base_url().'siproperty/assets/images/banner/banner-3.jpg';?>)"></div>
                    <div class="auto-container">
                        <div class="content-box">
                ...
                <div class="slide-item">
                    <div class="image-layer" style="background-image:url(<?php echo base_url().'siproperty/assets/images/banner/banner-4.jpg';?>)"></div>
                    <div class="auto-container">
                        <div class="content-box">
                            <h2>Search Properties for Sale and To Rent</h2>
                            <p>Amet consectetur adipisicing elit sed do eiusmod.</p>
        ...
        <section class="search-field-section">
            <div class="auto-container">
                        ...
                        <div class="tabs-box">
                            <div class="tab-btn-box">
                                <ul class="tab-btns tab-buttons centred clearfix">
                                    <li class="tab-btn active-btn" data-tab="#tab-1">Ongoing</li>
                                    <li class="tab-btn" data-tab="#tab-2">Completed</li>
                                </ul>
                            </div>
                                ...
                                <div class="tab active-tab" id="tab-1">
                                    <div class="inner-box">
                                        <div class="top-search">
                                            <form action="<?php echo base_url().'Home/search';?>" method="post" class="search-form">
                                                <div class="row clearfix">
                                                    <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="field-input">
                                                                ...
                                                                <input type="search" name="search" placeholder="Search by Property, Location or Landmark...">
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                foreach ($places as $pl){?>
                                           <option value="<?php echo $pl['prjlocation'];?>" <?php if ($seg==$pl['prjlocation']){?> selected <?php }?>><?php echo $pl['prjlocation'];?></option>
                                           <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="select-box">
                                                                <select class="wide" name="typ" >
                                                                   
                                                                   <option data-display="">Select</option>
                                           <option value="Villa" <?php if ($seg=='Villa'){?> selected <?php }?>>Villa</option>
                                           <option value="Commercial" <?php if ($seg=='Commercial'){?> selected <?php }?>>Commercial</option>
                                           <option value="Residential" <?php if ($seg=='Residential'){?> selected <?php }?>>Residential</option>
                                           <option value="Flat" <?php if ($seg=='Flat'){?> selected <?php }?>>Flat</option>
                                           <option value="Apartment" <?php if ($seg=='Apartment'){?> selected <?php }?>>Apartment</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div class="auto-container">
                ...
                <?php foreach($homeprojects as $hp){?>
                    <div class="feature-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="<?php echo base_url().'uploads/project/'.$hp['product_picture'];?>" alt="" class='imgftprp' ></figure>
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><!--img src="<?php //echo base_url().'siproperty/assets/images/feature/author-1.jpg';?>" alt=""--></figure>
                                        <h6><?php //echo $hp['agent'];
                                                            
                                                            $this->db->where('projectid',$hp['id']);
    ...
    $locdt=$query->row();
    echo $locdt->prjlocation;
                                                            
                                                            ?><?php //echo $hp['agent'];?></h6>
                                    </div>
                                    <div class="buy-btn pull-right"><a href="<?php echo base_url().'Home/contactUs';?>">For Buy</a></div>
                                </div>
                                <div class="title-text"><h4><a href="<?php echo base_url().'Home/'.'propertydetails';?>/<?php echo $hp['id'];?>"><?php echo $hp['project_name'];?></a></h4></div>
                                ...
                                <div class="btn-box"><a href="<?php echo base_url().'Home/'.'propertydetails';?>/<?php echo $hp['id'];?>" class="theme-btn btn-two">See Details</a></div>
                            </div>
                        </div>
                    </div>
                    <?php } ?>
                    <!--div class="feature-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/feature/feature-2.jpg';?>" alt=""></figure>
                                <div class="batch"><i class="icon-11"></i></div>
                            ...
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/feature/author-2.jpg';?>" alt=""></figure>
                                        <h6>Robert Niro</h6>
                                    </div>
                    ...
                    <div class="feature-block-one">
                        <div class="inner-box">
                            <div class="image-box">
                                <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/feature/feature-3.jpg';?>" alt=""></figure>
                                <div class="batch"><i class="icon-11"></i></div>
                                <span class="category">Featured</span>
                            </div>
                            <div class="lower-content">
                                <div class="author-info clearfix">
                                    <div class="author pull-left">
                                        <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/feature/author-3.jpg';?>" alt=""></figure>
                                        <h6>Keira Mel</h6>
                                    </div>
            ...
            <div class="auto-container">
                <div class="inner-box clearfix">
                    ...
                    <div class="btn-box">
                        ...
                        <a href="<?php echo base_url().'Home/propertylistcomp';?>" class="theme-btn btn-one">CompletedProjects</a>
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="single-item">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo base_url().'uploads/project/'.$hp['product_picture'];?>" alt="" class='imgbd' ></figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
                                    <div class="buy-btn"><a href="<?php echo base_url().'Home/propertydetails';?>">For Buy</a></div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="deals-block-one">
                                    <div class="inner-box">
                                        <div class="lower-content">
                                            <div class="title-text"><h4><a href="<?php echo base_url().'Home/propertydetails';?>"><?php echo $hp['project_name'];?></a></h4></div>
                                            <div class="price-box clearfix">
                                                <div class="price-info pull-left">
                                                    <h6>Start From</h6>
                                                    <h4><?php echo $hp['price'];?></h4>
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <!--img src="<?php //echo base_url().'siproperty/assets/images/feature/author-1.jpg';?>" alt=""-->
                                                        <span><?php //echo $hp['agent'];
    ...
    echo $locdt->prjlocation;
                                                            ...
                                                            ?>,<br><?php echo $locdt->prjaddress;?></span>
                                                    </figure>
                                                </div>
                                            </div>
                                            <p><?php echo $hp['shortdesc'];?></p>
                                        ...
                                        <li><i class="icon-16"></i><?php echo $hp['squarefeet'];?> Sq Ft</li>
                                            ...
                                            <div class="other-info-box clearfix">
                                                <div class="btn-box pull-left"><a href="<?php echo base_url().'Home/'.'propertydetails';?>/<?php echo $hp['id'];?>" class="theme-btn btn-one">See Details</a></div>
                                                <ul class="other-option pull-right clearfix">
                                                    <li><a href="#"><i class="icon-12"></i></a></li>
                                                    <li><a href="#"><i class="icon-13"></i></a></li>
                                                </ul>
                    ...
                    <!--div class="single-item">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-6 col-sm-12 deals-block">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo base_url().'siproperty/assets/images/resource/deals-2.jpg';?>" alt=""></figure>
                                    <div class="batch"><i class="icon-11"></i></div>
                                    <span class="category">Featured</span>
                                    ...
                                    <div class="inner-box">
                                        <div class="lower-content">
                                            ...
                                            <div class="price-box clearfix">
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <img src="<?php echo base_url().'siproperty/assets/images/feature/author-2.jpg';?>" alt="">
                                    ...
                                    <div class="inner-box">
                                        <div class="lower-content">
                                            ...
                                            <div class="price-box clearfix">
                                                ...
                                                <div class="author-box pull-right">
                                                    <figure class="author-thumb"> 
                                                        <img src="<?php echo base_url().'siproperty/assets/images/feature/author-3.jpg';?>" alt="">
                                                        <span>Keira Mel</span>
                                                    </figure>
                                                </div>
                                            </div>
        ...
        <!--section class="team-section sec-pad centred">
            <div class="auto-container">
                <div class="sec-title">
                <h5>Our Leaders</h5>
                <h2>Meet Our Excellent Leaders</h2>
                </div>
                <div class="row clearfix"-->
                <?php 
                //print_r($testimonial);
                ...
                //foreach ($agents as $ag){
                    ...
                    <!--div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="<?php echo base_url().'uploads/teammembers/'.$ag['image'];?>" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                                        <h4><a href="<?php echo base_url().'Home/contactUs';?>"><?php echo $ag['name'];?></a></h4>
                                        <span class="designation"><?php echo $ag['designation'];?></span>
                                        <ul class="social-links clearfix">
                                            <li><a href="<?php echo $ag['Fblink'];?>"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="<?php echo $ag['TwitterLink'];?>"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="<?php echo $ag['YouTubeLink'];?>"><i class="fab fa-google-plus-g"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!--div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/team/team-7.jpg';?>" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/team/team-8.jpg';?>" alt=""></figure>
                                <div class="lower-content">
                                    <div class="inner">
                        ...
                        <div class="content_block_2">
                            <div class="content-box">
                                <div class="sec-title">
                                    ...
                                    <p><!--Lorem ipsum dolor sit amet consectetur adipisicing do eumod tempor.-->SI property has established itself as one of the leading builders in Trivandrum with a strong presence throughout the metropolitan city</p>
                                </div>
    ...
    $rowcount = $query->num_rows();?>
        ...
        <!--section class="clients-section bg-color-1">
            <div class="pattern-layer" style="background-image: url(<?php //echo base_url().'siproperty/assets/images/shape/shape-1.png';?>);"></div>
            <div class="auto-container">
                <div class="row clearfix">
                ...
                //foreach ($clients as $ct){?>
                                <li>
                                    <figure class="logo"><img src="<?php //echo base_url().'uploads/clients/'.$ct['image'];?>" alt=""></figure>
                                </li>
                                <?php //} ?>
                ...
                foreach ($testimonial as $test){?>
                            ...
                            <!--div class="testimonial-block-two">
                                <div class="inner-box">
                                    ...
                                    <div class="author-info">
                                        <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/resource/testimonial-2.jpg';?>" alt=""></figure>
                                        <h4>Marc Kenneth</h4>
        ...
        <section class="news-section sec-pad">
            <div class="auto-container">
                <div class="sec-title centred">
                    ...
                    <p>Join us on this journey as we explore the exciting possibilities of construction and design! <br />Our homes are the beacon of hope, dreams, and happiness.</p>
                </div>
                <div class="row clearfix">
                <?php foreach($blog as $blg){?>
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="<?php echo base_url().'Home/blogdetails/'.$blg['blogid'];?>"><img src="<?php echo base_url().'uploads/blog/'.$blg['frontpicture'];?>" alt="" class="imgftblg"></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        ...
                                        echo $month = date('d',strtotime($date));?> <?php echo $month = date('M',strtotime($date));?>, <?php echo $datedt[0];?></li>
                                    </ul>
                                    <div class="text">
                    ...
                    <!--div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="blog-details.html"><img src="<?php echo base_url().'siproperty/assets/images/news/news-2.jpg';?>" alt=""></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/news/author-2.jpg';?>" alt=""></figure>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div class="news-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><a href="blog-details.html"><img src="<?php echo base_url().'siproperty/assets/images/news/news-3.jpg';?>" alt=""></a></figure>
                                    <span class="category">Featured</span>
                                </div>
                                <div class="lower-content">
                                    ...
                                    <ul class="post-info clearfix">
                                        <li class="author-box">
                                            <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/news/author-3.jpg';?>" alt=""></figure>
        ...
        <footer class="main-footer">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12 footer-column">
                            <div class="footer-widget post-widget">
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img src="<?php echo base_url().'siproperty/assets/images/resource/footer-post-1.jpg';?>" alt=""></a></figure>
            ...
            <div class="footer-bottom">
                <div class="auto-container">
                    <div class="inner-box clearfix">
                        <figure class="footer-logo"><a href="index.html"><img src="<?php echo base_url().'siproperty/assets/images/footer-logo.png';?>" alt=""></a></figure>
    ...
    <script src="<?php echo base_url().'siproperty/assets/js/jquery.paroller.min.js';?>"></script>
    <script src="<?php echo base_url().'siproperty/assets/js/nav-tool.js';?>"></script>
