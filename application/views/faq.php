                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-column">
                        <div class="faq-content-side">
                            <div class="sec-title">
                                ...
                                <p>Our FAQ section is designed to provide clear, straightforward answers</p>
                            </div>
                    ...
                    ?>
                                ...
                                <li class="accordion block active-block">
                                    <div class="acc-btn active">
                                        ...
                                        <h5><?php echo $fq['ques'];?></h5>
                                    </div>
                                    <div class="acc-content current">
                                        <div class="content-box">
                                            <p><?php echo $fq['content'];?></p>
                                            <?php $list=explode(',',$fq['points']);?>
                        ...
                        <div class="faq-sidebar">
                            <div class="question-inner">
                                ...
                                <form method="post" id="frmcontact" action="<?php echo base_url().'Home/contactusprocess';?>"> 
                                        ...
                                        <div class="form-group">
                                            <textarea name="message" placeholder="Your message" class='frm'></textarea>
                                        </div>
