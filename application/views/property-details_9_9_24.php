...
<link href="<?php echo base_url().'siproperty/assets/css/timePicker.css';?>" rel="stylesheet">
        ...
        <section class="page-title-two bg-color-1 centred">
            ...
            <div class="auto-container">
                <div class="content-box clearfix">
                    <h1><?php echo $pd1->project_name;?></h1>
                    <ul class="bread-crumb clearfix">
                        <li><a href="<?php echo base_url().'Home/index';?>">Home</a></li>
                        <li><?php echo $pd1->project_name;?></li>
                    </ul>
                </div>
            </div>
        </section>
                    ...
                    <div class="right-column pull-right clearfix">
                        <div class="price-inner clearfix">
                            <ul class="category clearfix pull-left">
                                <li><a href="<?php echo base_url().'Home/contactUs';?>"><?php //echo $pd->project_status;
                                    ...
                                    //print_r($pd1);
                                    ?></a></li>
                                <li><a href="tel:<?php echo $contactus->phoneno;?>">Call Now</a></li>
                            </ul>
...
foreach($pic as $pi){?>
                                    ...
                                    <figure class="image-box"><img src="<?php echo base_url().'uploads/project/'.$pic[$i];?>" alt=""></figure>
                                <?php
                            $i++;
                            
                            }?>
                                    <!--figure class="image-box"><img src="<?php //echo base_url().'siproperty/assets/images/resource/property-details-2.jpg';?>" alt=""></figure>
                                    <figure class="image-box"><img src="<?php //echo base_url().'siproperty/assets/images/resource/property-details-3.jpg';?>" alt=""></figure-->
                                </div>
                            </div>
                            ...
                            <div class="details-box content-widget">
                                ...
                                <ul class="list clearfix">
                                    <li>Property ID: <span><?php echo $pd1->propertyid;?></span></li>
                                    <li>Rooms: <span><?php echo $pd1->rooms;?></span></li>
                                    <li>Garage Size: <span><?php echo $pd1->garagesize;?></span></li>
                                    <li>Property Price: <span><?php echo $pd1->price;?></span></li>
                                    <li>Bedrooms: <span><?php echo $pd1->bedroom;?></span></li>
                                    <li>Year Built: <span><?php echo $pd->yearbuilt;?></span></li>
                                    <li>Property Type: <span><?php echo $pd->propertytype;?></span></li>
                                    <li>Bathrooms: <span><?php echo $pd1->bathroom;?></span></li>
                                    <li>Property Status: <span><?php //echo $pd->project_status;
                                    if ($pd1->project_status==0){
                                        echo "Ongoing";
                                    }
                                    else{
                                    ...
                                    //print_r($pd1);
                                    ?></span></li>
                                    <li>Property Size: <span><?php echo $pd1->squarefeet;?></span></li>
                                    <li>Garage: <span><?php echo $pd1->noofgarage;?></span></li>
                                </ul>
                            </div>
                            ...
                            <div class="location-box content-widget">
                                ...
                                <!--div class="google-map-area">
                                    <div 
                                        ...
                                        data-icon-path="<?php //echo base_url().'siproperty/assets/images/icons/map-marker.png';?>"  
                                        data-map-title="Brooklyn, New York, United Kingdom" 
                                        data-map-zoom="12" 
                                        data-markers='{
                                            "marker-1": [40.712776, -74.005974, "<h4>Branch Office</h4><p>77/99 New York</p>","<?php echo base_url().'siproperty/assets/images/icons/map-marker.png';?>"]
                                        }'>
...
$i++;
                            ...
                            <!--div class="statistics-box content-widget">
                                ...
                                <figure class="image-box">
                                    <a href="<?php //echo base_url().'siproperty/assets/images/resource/statistics-1.png';?>" class="lightbox-image" data-fancybox="gallery"><img src="<?php echo base_url().'siproperty/assets/images/resource/statistics-1.png';?>" alt=""></a>
                                </figure>
                            </div-->
                        ...
                        <div class="property-sidebar default-sidebar">
                            <div class="author-widget sidebar-widget">
                                <div class="author-box">
                                    <figure class="author-thumb"><img src="<?php echo base_url().'siproperty/assets/images/resource/author-11.png';?>" alt=""></figure>
                                    <div class="inner">
                                        <h4>SI Property</h4>
                                        <ul class="info clearfix">
                                            <li><i class="fas fa-map-marker-alt"></i><?php echo $contactus->location;?><?php echo $contactus->state;?>,<?php echo $contactus->country;?></li>
                                            <li><i class="fas fa-phone"></i><a href="tel:<?php echo $contactus->phoneno;?>"><?php echo $contactus->phoneno;?></a></li>
                                        </ul>
                                        <div class="btn-box"><a href="<?php echo base_url().'Home/contactUs';?>">View Details</a></div>
                                    </div>
                                </div>
                                <div class="form-inner">
                                    <!--form action="property-details.html" method="post" class="default-form"-->
                                    <span id='msg' style='color:green;font-weight:bold;'></span>
                                    <form method="post" id="frmcontact"  action="<?php echo base_url().'Home/contactusprocess';?>" class="default-form">
                                        <div class="form-group">
                                            <input type="text" name="name" placeholder="Your name" required="" class='frm'>
                                        </div>
                                        <div class="form-group">
                                            <input type="email" name="email" placeholder="Your Email" required="" class='frm'>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="phone" placeholder="Phone" required="" class='frm'>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="subject" placeholder="Subject" required="" class='frm'>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="message" placeholder="Message" class='frm'></textarea>
                                        </div>
                                        <div class="form-group message-btn">
...
shareButton.addEventListener('click', () => {
 ...
 const shareUrl = 'http://localhost/siproperty_new/Home/propertydetails/1';
