...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h3>List Settings</h3>
      <?php echo $this->session->flashdata('flash_msgst'); ?>

      <?php if ($this->session->flashdata('flash_msgst')): ?>
      ...
      <table class="table table-striped b-t">
        ...
        ?>
          ...
          <td><img src="<?php echo base_url().'uploads/settings/'.$row['logo'];?>" width="50" height="50" /></td>
           ...
           <td>
           <a href="<?php echo base_url().'admin/editsettings/'.$row['id'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            <!--button class="delete btn btn-danger"><a href="#" onclick="delrow(<?php echo $row['id'];?>)">
                Delete
            </button--->
            </td>
          </tr>          
