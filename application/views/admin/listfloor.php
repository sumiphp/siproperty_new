...
<div class="padding">
  ...
  <div class="box">
    ...
    <?php if ($this->session->flashdata('flash_msglg')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msglg'); ?>
            </div>
        <?php endif; ?>
      <h3>List Floor</h3>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t">
        ...
        ?>
            ...
            <td><?php echo $i;?></td>
            <td><?php echo $res['floorname'] ?></td>
            <td><?php $prjid=$res['projectid'];
            
            
            $this->db2->where('id',$prjid);
	$this->db2->select('*');
    $this->db2->from('home_projects');
    $query = $this->db2->get();
   $prjdt=$query->row();
   echo $pn=$prjdt->project_name;
            ...
            ?></td>
            <td><?php if ($res['status']==1){ echo "Active"; } else if ($res['status']==0){ echo "InActive";}
            /*else{
                echo "Floor";
            }*/
            ...
            $imgpath="gallery";
             ?>
            <td>
            <img  style="height:8em; width:7em" src=<?php echo base_url().'uploads/project/'.$res['picture']?> >
            </td>
           <td>
           <a href="<?php echo base_url().'admin/editfloor/'.$res['floorid'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            ...
            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletefloor/'.$res['floorid'];?>">
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'Admin/deletefloor';?>",
            data:{id:id},
