            ...
            <div class="collapse navbar-collapse" id="collapse">
              ...
              <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?php echo base_url().'Admin/listsettings'?>">
...
<div class="padding">
  ...
  <div class="p-x-xs">
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Fblink</label>
      <div class="col-sm-6">
      <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $re['id'];?>" placeholder="Enter Menu Name" required>
        <input type="text" class="form-control rounded" name='Fblink' id='Fblink' required value="<?php echo $re['Fblink'];?>">
      </div>
    </div>

   
    <div class="form-group row">
      <label class="col-sm-2 form-control-label" for="input-id-1">TwitterLink</label>
      <div class="col-sm-6">
        <input type="text" class="form-control rounded"  name='TwitterLink' id='TwitterLink' value="<?php echo $re['TwitterLink'];?>" required>
      </div>
    </div>
    
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">YouTubeLink</label>
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='YouTubeLink' id='YouTubeLink' value="<?php echo $re['YouTubeLink'];?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Insta</label>
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='insta' id='insta' value="<?php echo $re['insta'];?>" required>
      </div>
    </div>
    
    
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Linkedlink</label>
      <div class="col-sm-6">
        <input type="text"  class="form-control rounded" placeholder="" name='Linkedlink' id='Linkedlink' value="<?php echo $re['linkedlink'];?>" required>
      </div>
    </div>

    <div class="form-group row">
      <label class="col-sm-2 form-control-label">PInterest link</label>
      <div class="col-sm-6">
        <input type="text"  class="form-control rounded" placeholder="" name='pinterest' id='pinterest' value="<?php echo $re['pinterest'];?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Place</label>
      <div class="col-sm-6">
        <input type="text"  class="form-control rounded" placeholder="" name='place' id='place' value="<?php echo $re['place'];?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text"  class="form-control rounded" placeholder="" name='city' id='city' value="<?php echo $re['city'];?>" required>
      </div>
    </div>
        ...
        <div class="form-group row">
      <label class="col-sm-2 form-control-label">Footer About Us1</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='desc' id='desc' required ><?php echo $re['footercontent'];?></textarea>
      </div>
    </div>
        

    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Footer About Us2</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='desc2' id='desc2' required ><?php echo $re['footercontent2'];?></textarea>
      </div>
    </div>
...
$('#add').on('submit', function (e) {
    ...
    // alert("add");
       ...
       var place=$('#place').val();
        ...
        form_data.append('Fblink',Fblink);
        form_data.append('linkedlink',linkedlink);
        form_data.append('insta',insta);
        form_data.append('TwitterLink',TwitterLink);
        form_data.append('YouTubeLink',YouTubeLink);
        form_data.append('city',city);
        form_data.append('place',place);
        form_data.append('pinterest',pinterest);
       
        $.ajax({
            url: "<?php echo base_url().'Admin/addsettingsprocess';?>", // point to server-side controller method
    ...
    window.location.href ="<?php echo base_url().'Admin/listsettings';?>";
