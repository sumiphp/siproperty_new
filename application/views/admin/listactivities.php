...
<div class="padding">
  ...
  <div class="box">
    <div class="box-header">
      <h3>List Reason to chooseus</h3>
    </div>
    <?php if ($this->session->flashdata('flash_msger')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msger'); ?>
            </div>
        <?php endif; ?>
    <div class="row p-a">
      ...
      <table class="table table-striped b-t">
        ...
        ?>
            ...
            $imgpath="gallery";
             ?>
            <!--td>
            <img  style="height:8em; width:7em" src=<?php //echo base_url().'uploads/activities/'.$res['image']?> >
            </td-->
           <!--td--->
            ...
            ?></td>
            <td>
           <a href="<?php echo base_url().'admin/editreason/'.$res['id'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            <!--button class="delete btn btn-danger" onclick="delrow(<?php //echo $res['id'];?>)">
                Delete
            </button-->

            <a  onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletereason/'.$res['id'];?>">
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'Admin/deletereason';?>",
            data:{id:id},
