            ...
            <div class="collapse navbar-collapse" id="collapse">
              ...
              <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?php echo base_url().'Admin/listprojects'?>">
...
<div class="padding">
  ...
  <?php if ($this->session->flashdata('message')): ?>
        ...
        <?php endif; ?>
  <form action="<?= base_url('admin/editprojectprocess'); ?>" method="post" enctype="multipart/form-data">
...
//echo $ceo['categoryid'];?>
 <?php foreach ($home_project as $ceo): ?>
  <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="categories" name="categories" required>
            ...
            <option value="<?php echo $ct['cat_id'];?>" <?php if($ct['cat_id']==$ceo['categoryid']){ ?> selected <?php }?>><?php echo $ct['cat_name'];?> </option>
            <?php } ?>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="projetname" class="form-control rounded" value="<?= $ceo['project_name']; ?>" required>
      </div>
    </div>
    <input type="hidden" class="form-control" id="id" name="id" value="<?= $ceo['id']; ?>" placeholder="Enter Menu Name" required>
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Price Starts from</label>
      <div class="col-sm-6">
        <input type="text" name="pricestart" class="form-control rounded" value="<?= $ceo['price']; ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name="no_bed" id="input-id-1" value="<?= $ceo['bedroom']; ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="no_bathroom" class="form-control rounded" value="<?= $ceo['bathroom']; ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="no_square"  class="form-control rounded" value="<?= $ceo['squarefeet']; ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name="propertyid" id="input-id-1" value="<?= $ceo['propertyid']; ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="rooms" class="form-control rounded" value="<?= $ceo['rooms']; ?>" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="garagesize"  class="form-control rounded" value="<?= $ceo['garagesize']; ?>" placeholder="" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" name="noofgarage"  class="form-control rounded" value="<?= $ceo['noofgarage']; ?>" placeholder="" required>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="show" name="show" required>
        ...
        <img class="mt-3" src="<?php echo base_url().'uploads/project/'.$ceo['product_picture'];?>" width="100" height="100" />
        </div>
