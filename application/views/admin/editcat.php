...
<div class="padding">
  ...
  <div class="p-x-xs">
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='title' id='title' required value="<?php echo $result->cat_name;?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="actionSelect">
        ...
        <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $result->cat_id;?>" placeholder="Enter Menu Name" required>
        <div class="form-group row">
      <label class="col-sm-2 form-control-label">Status</label>
      <div class="col-sm-6">
       <select class="form-control rounded" id="status" name="status" required>
            <option value="">Select</option>
            <option value="1" <?php if ($result->cat_status==1){?> selected <?php } ?>>Active </option>
            <option value="0" <?php if ($result->cat_status==0){?> selected <?php } ?>>Not Active</option>        
        </select>        
        </div>      
        </div>
        ...
        <input type="file"  class="form-control" id="image1" name="image1">
            ...
            <img class="mt-3" src="<?php echo base_url().'uploads/category/'.$result->image;?>" width="100" height="100" />
        </div>
...
$('#edit').on('submit', function (e) {
    ...
    // alert("add");
      ...
      form_data.append('title',title);
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/editcatprocess';?>", // point to server-side controller method
    ...
    <?php $this->session->set_flashdata('flash_msgge', 'Category edited Successfully');
    ?>
    window.location.href="<?php echo base_url().'Admin/listcat';?>";
            },
