...
<div class="padding">
  ...
  <form id="editblog" role="form" class="mt-2" method="post" enctype="multipart/form-data">
  <div class="p-x-xs">
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Blog Title</label>
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='title' id='title' required value="<?=$result->blogtitle;?>">
      </div>
    </div>
    ...
    <input type="hidden" class="form-control rounded" name='id' id='id' required value="<?=$result->blogid;?>">
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Blog Short Descripition</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='shortdesc' id='shortdesc' required ><?=$result->blogshortdesc;?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdesc' id='longdesc' required ><?=$result->bloglongdesc;?></textarea>
      </div>
    </div>

    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Blog  Descripition2</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdesc2' id='longdesc2' required ><?=$result->blogdesc2;?></textarea>
      </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="status" name="status" required>
        ...
        <img class="mt-3" src="<?php echo base_url().'uploads/blog/'.$result->picture;?>" width="100" height="100" />
        </div>
    ...
    <div class="form-group row">
        ...
        <img class="mt-3" src="<?php echo base_url().'uploads/blog/'.$result->picture2;?>" width="100" height="100" />
                    </div>
    </div>
...
$('#editblog').on('submit', function (e) {
    ...
    // alert("add");
      ...
      form_data.append('title',title);
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/editblogprocess';?>", // point to server-side controller method
    ...
    window.location.href ="<?php echo base_url().'Admin/listblog';?>";
