...
<div class="padding">
  ...
  <div class="box">
    ...
    <?php if ($this->session->flashdata('flash_msgge')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgge'); ?>
            </div>
        <?php endif; ?>
      <h3>List Gallery</h3>
    </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t">
        ...
        ?>
            ...
            <td><?php if ($res['type1']==1){ echo "Exterior"; } else if ($res['type1']==2){ echo "Interior";}
            else{
                echo "Floor";
            }
            ...
            $imgpath="gallery";
             ?>
            <td>
            <img  style="height:8em; width:7em" src=<?php echo base_url().'uploads/gallery/'.$res['image']?> >
            </td>
           <td>
           <a href="<?php echo base_url().'admin/editgallery/'.$res['id'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            ...
            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletegallery/'.$res['id'];?>">
