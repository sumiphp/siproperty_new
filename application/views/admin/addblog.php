...
<div class="padding">
  ...
  <?php if ($this->session->flashdata('flash_msgbg')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgbg'); ?>
            </div>
        <?php endif; ?>
  <form action="<?= base_url('admin/addblogprocess'); ?>" method="post" enctype="multipart/form-data">
  <div class="p-x-xs">
    ...
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Blog  Descripition1</label>
      <div class="col-sm-6">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdesc2' id='longdesc2' required ></textarea>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Quote  Descripition2</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdescq' id='longdescq' required ></textarea>
      </div>
    </div>
