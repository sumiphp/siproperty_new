            ...
            <div class="collapse navbar-collapse" id="collapse">
              ...
              <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?php echo base_url().'Admin/editcontactus'?>">
...
<div class="padding">
  ...
  <?php if ($this->session->flashdata('flash_msgcs')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgcs'); ?>
            </div>
        <?php endif; ?>
  <!--form id="edit" role="form" class="mt-2" method="post" enctype="multipart/form-data"-->
  <form action="<?= base_url('admin/editcontactusprocess'); ?>" method="post" enctype="multipart/form-data">
  <?php 
  //print_r($result);
  ...
  <div class="p-x-xs">
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='location' id='location' required ><?php echo $re->location;?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='state' id='state' required ><?php echo $re->state;?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='country' id='country' required value="<?php echo $re->country;?>">
      </div>
    </div>
