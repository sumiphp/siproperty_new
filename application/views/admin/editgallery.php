            ...
            <div class="collapse navbar-collapse" id="collapse">
              ...
              <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?php echo base_url().'Admin/listgallery'?>">
...
<div class="padding">
  ...
  <div class="p-x-xs">
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='title' id='title' required value="<?php echo $result->caption;?>">
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="status" name="status" required>
            ...
            <option value="0" <?php if ($result->status==0){?> selected <?php } ?>>Not Active</option>        
        </select>        
        </div>      
        </div>
        <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="type" name="type" required>
            <option value="">Select</option>
            <option value="2" <?php if ($result->type1==2){?> selected <?php } ?>>Interior </option>
            <option value="1" <?php if ($result->type1==1){?> selected <?php } ?>>Exterior</option> 
            <option value="3" <?php if ($result->type1==3){?> selected <?php } ?>>Floor Plan</option>
            <!--option value="4" <?php //if ($result->type1==4){?> selected <?php //} ?>>All</option-->                    
        </select>        
        </div>      
        </div>
        ...
        <input type="file"  class="form-control" id="image1" name="image1">
            ...
            <img class="mt-3" src="<?php echo base_url().'uploads/gallery/'.$result->image;?>" width="100" height="100" />
        </div>
...
$('#edit').on('submit', function (e) {
    ...
    // alert("add");
      ...
      form_data.append('title',title);
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/editgalleryprocess';?>", // point to server-side controller method
    ...
    <?php $this->session->set_flashdata('flash_msgge', 'Gallery edited Successfully');
    ?>
    window.location.href="<?php echo base_url().'Admin/listgallery';?>";
            },
