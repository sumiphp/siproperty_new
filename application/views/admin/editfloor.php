            ...
            <div class="collapse navbar-collapse" id="collapse">
              ...
              <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?php echo base_url().'Admin/listblog'?>">
...
<div class="padding">
  ...
  <?php if ($this->session->flashdata('flash_msgfl')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgfl'); ?>
            </div>
        <?php endif; ?>
  <form action="<?= base_url('admin/editfloorprocess'); ?>" method="post" enctype="multipart/form-data">
  <div class="p-x-xs">
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Floor Title</label>
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='title' id='title' required value="<?php echo $result1->floorname;?>">
      </div>
    </div>
    <input type="hidden" class="form-control" id="id" name="id" value="<?php echo $result1->floorid;?>" placeholder="Enter Menu Name" required>
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Select Project</label>
      <div class="col-sm-6">
       
            <select class="form-control rounded" id="project" name="project" required>
            <option value="">Select</option>
            <?php foreach($result as $res){?>
            <option value="<?php echo $res['id'];?>" <?php if($result1->projectid==$res['id']){?>selected <?php }?>><?php echo $res['project_name'];?> </option>
            <?php } ?>
    ...
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Floor Descripition</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdesc' id='longdesc' required ><?php echo $result1->floordesc;?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="actionSelect">
        ...
        <div class="form-group row">
      <label class="col-sm-2 form-control-label">Floor Status</label>
      <div class="col-sm-6">
       <select class="form-control rounded" id="status" name="status" required>
            <option value="">Select</option>
            <option value="1" <?php if($result1->status==1){?>selected <?php }?>>Active </option>
            <option value="0" <?php if($result1->status==0){?>selected <?php }?>>Not Active</option>           
        </select>        
        </div>      
        </div>
        ...
        <img class="mt-3" src="<?php echo base_url().'uploads/project/'.$result1->picture;?>" width="100" height="100" />
            <!--div class="form-file">
