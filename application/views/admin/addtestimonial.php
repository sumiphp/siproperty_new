...
<?php if ($this->session->flashdata('flash_msgte')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgte'); ?>
            </div>
        <?php endif; ?>
  <form action="<?= base_url('admin/addtestimonialsprocess'); ?>" method="post" enctype="multipart/form-data">
...
$('#add').on('submit', function (e) {
    ...
    // alert("add");
       var file_data1 = $('#image1').prop('files')[0];
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/addtestimonialsprocess';?>", // point to server-side controller method
