    ...
    <div class="table-responsive">
      <table class="table table-striped b-t">
        ...
        ?>
            ...
            <td><div class="div"><?php echo $res['shortdesc'] ?></div></td>
            ...
            $imgpath="carosel";
             ?>
            <td>
            <img  style="height:8em; width:7em" src=<?php echo base_url().'uploads/division/'.$res['picture']?> >
            </td>
           <td>
           <a href="<?php echo base_url().'admin/editdivision/'.$res['id'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            
            <!--a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php //echo base_url().'admin/deleteblog/'.$res['blogid'];?>">
