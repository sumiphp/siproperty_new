...
<div class="padding">
  ...
  <div class="p-x-xs">
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='title' id='title' required value="<?=$result->title;?>">
      </div>
    </div>
    ...
    <input type="hidden" class="form-control rounded" name='id' id='id' required value="<?=$result->id;?>">
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Short Descripition</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='shortdesc' id='shortdesc' required ><?=$result->shortdesc;?></textarea>
      </div>
    </div>

    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Long Descripition</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdesc' id='longdesc' required ><?=$result->longdesc;?></textarea>
      </div>
    </div>

    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Descripition2</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdesc2' id='longdesc2' required ><?=$result->desc2;?></textarea>
      </div>
    </div>
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Quote  Descripition2</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='longdescq' id='longdescq' required ><?=$result->quotedesc;?></textarea>
      </div>
    </div>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
       <select class="form-control rounded" id="status" name="status" required>
        ...
        <div class="form-group row">
        <label class="col-sm-2 form-control-label">Picture1</label>
      
        <div class="col-sm-6">
        <input type="file"  class="form-control" id="image1" name="image1">
        <img class="mt-3" src="<?php echo base_url().'uploads/division/'.$result->picture;?>" width="100" height="100" />
        </div>

    </div>

    <div class="form-group row">
        <label class="col-sm-2 form-control-label">Picture2</label>
      
        <div class="col-sm-6">
        <input type="file"  class="form-control" id="image2" name="image2" >
        <img class="mt-3" src="<?php echo base_url().'uploads/division/'.$result->picture2;?>" width="100" height="100" />
                    </div>
    </div>
...
$('#edit').on('submit', function (e) {
    ...
    // alert("add");
      ...
      form_data.append('title',title);
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/editdivprocess';?>", // point to server-side controller method
    ...
    window.location.href ="<?php echo base_url().'Admin/listdivision';?>";
