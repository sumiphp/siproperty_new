            ...
            <div class="collapse navbar-collapse" id="collapse">
              ...
              <ul class="nav navbar-nav mr-auto">
                <li class="nav-item dropdown">
                  <a class="nav-link" href="<?php echo base_url().'Admin/listactivities'?>">
...
<div class="padding">
  ...
  <div class="p-x-xs">
    ...
    <!--div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='name' id='name' required>
    ...
    <div class="form-group row">
      ...
      <div class="col-sm-6">
        <input type="text" class="form-control rounded" name='designation' id='designation' required>
      </div>
    </div-->
    <div class="form-group row">
      <label class="col-sm-2 form-control-label">Descripition</label>
      <div class="col-sm-6">
        <textarea class="form-control" rows="5" name='desc' id='desc' required ><?php echo $result->shortdesc;?></textarea>
      </div>
    </div>
...
$('#edit').on('submit', function (e) {
    ...
    // alert("add");
       ...
       var status=$("#status").val();                
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/editreasonprocess';?>", // point to server-side controller method
            ...
            success: function (response) {
                ...
                window.location.href="<?php echo base_url().'Admin/listactivities';?>";
            },
