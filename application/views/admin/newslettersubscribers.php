...
<div class="padding">
  ...
  <div class="box">
    ...
    <?php if ($this->session->flashdata('flash_msgsub')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgsub'); ?>
            </div>
        <?php endif; ?>
      ...
      <table class="table table-striped b-t">
        ...
        ?>
           ...
           <!--a href="<?php //echo base_url().'admin/editcarousel/'.$res['newsletterid'];?>"><button class="btn btn-success" >
            ...
            <!--button class="delete btn btn-danger" onclick="delrow(<?php //echo $res['newsletterid'];?>)">
                Delete
            </button-->
            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletesubscribers/'.$res['newsletterid'];?>">
