      ...
      <table class="table table-striped b-t">
        ...
        ?>
            ...
            $imgpath="gallery";
             ?>
            <td>
            <img  style="height:8em; width:7em" src=<?php echo base_url().'uploads/category/'.$res['image']?> >
            </td>
           <td>
           <a href="<?php echo base_url().'admin/editcat/'.$res['cat_id'];?>"><button class="btn btn-success" >
                Edit
            </button></a> 
            ...
            <a onclick="return confirm('Are you sure you want to delete this item?');" href="<?php echo base_url().'admin/deletecat/'.$res['cat_id'];?>">
...
$.ajax({
            type: 'GET',
            url: "<?php echo base_url().'Admin/deletecat
            ';?>",
            data:{id:id},
