...
<!-- ############ PAGE START-->
<div class="padding">
  <h6>Add Reason to choose us</h6>
  <p>
  Fill out the required details.
  </p>
  <span id="msg" class="text-success"></span><br>
  <?php if ($this->session->flashdata('flash_msgre')): ?>
            <div class="alert alert-success">
                <?php echo $this->session->flashdata('flash_msgre'); ?>
            </div>
        <?php endif; ?>
  <!--form id="add" role="form" class="mt-2" method="post" enctype="multipart/form-data"-->
  <form action="<?= base_url('admin/addreasonprocess'); ?>" method="post" enctype="multipart/form-data">
  <div class="p-x-xs">
...
$('#add').on('submit', function (e) {
    ...
    // alert("add");
       ...
       var status=$("#status").val();                
        ...
        $.ajax({
            url: "<?php echo base_url().'Admin/addreasonprocess';?>", // point to server-side controller method
