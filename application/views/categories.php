                ...
                //foreach ($cat as $ct){?>
                        ...
                        <!--li>
                            <div class="category-block-one">
                                <div class="inner-box">
                                    <div class="icon-box"><?php //echo $ct['cat_image'];?></div>
                                    <h5><a href="property-details.html"><?php //echo $ct['cat_name'];?></a></h5>
                                    <span>52</span>
                                </div>
                            </div>
                        </li-->
                ...
                foreach ($cat as $ct){?>
                        ...
                        <li>
                            <div class="category-block-one">
                                <div class="inner-box">
                                    <div class="icon-box"><?php echo $ct['cat_image'];?></div>
                                    <h5><a href="<?php echo base_url().'Home/propertylist';?>"><?php echo $ct['cat_name'];?></a></h5>
                                    <span><?php  
                                    $this->db->where('categoryid',$ct['cat_id']);
                                    $this->db->select('*');
        ...
        <section class="cta-section alternate-2 centred" style="background-image: url(<?php echo base_url().'siproperty/assets/images/background/cta-1.jpg';?>);">
            <div class="auto-container">
                <div class="inner-box clearfix">
                    ...
                    <div class="btn-box">
                        <a href="<?php echo base_url().'Home/propertyliston';?>" class="theme-btn btn-three" style='font-size:13px; !important'>Ongoing Properties</a>
                        <a href="<?php echo base_url().'Home/propertylistcomp';?>" class="theme-btn btn-one" style='font-size:13px; !important'>Completed Properties</a>
                    </div>
                </div>
            </div>
        </section>
