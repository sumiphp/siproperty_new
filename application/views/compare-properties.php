                    ...
                    <table class="properties-table">
                        <thead class="table-header">
                            <tr>
                                <th>Property Info</th>
                                <th>
                                    <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/resource/table-img-1.jpg';?>" alt=""></figure>
                                    <div class="title">Villa on Grand Avenue</div>
                                    <div class="price">$45,000.00</div>
                                </th>
                                <th>
                                    <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/resource/table-img-2.jpg';?>" alt=""></figure>
                                    <div class="title">Contemporary Apartment</div>
                                    <div class="price">$45,000.00</div>
                                </th>
                                <th>
                                    <figure class="image-box"><img src="<?php echo base_url().'siproperty/assets/images/resource/table-img-3.jpg';?>" alt=""></figure>
