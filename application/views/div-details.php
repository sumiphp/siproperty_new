                    ...
                    <div class="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div class="blog-details-content">
                            <div class="news-block-one">
                                <div class="inner-box">
                                    <div class="image-box">
                                        <figure class="image"><img src="<?php echo base_url().'uploads/division/'.$pd2->picture2;?>" alt=""  class="bl"></figure>
                                        <span class="category"><?php echo $pd2->type ;?></span>
                                    </div>
                                    <div class="lower-content">
                                        <h3> <?php echo $pd2->title ;?></h3>
                                        <!--ul class="post-info clearfix">
                                            <li class="author-box">
                                                <figure class="author-thumb"><img src="<?php echo base_url().'uploads/division/'.$pd2->authorpicture;?>" alt="" ></figure>
...
//echo $month = date('d',strtotime($date));?> <?php //echo $month = date('M',strtotime($date));?>, <?php //echo $datedt[0];?></li>
                                        ...
                                        <div class="text">
                                            <p><?php echo $pd2->shortdesc ;?></p>
                                            <p><?php echo $pd2->longdesc ;?></p>
                                            <blockquote>
                                                <h4>“<?php echo $pd2->quotedesc;?>”</h4>
                                            </blockquote>
                                            <p><?php echo $pd2->desc2 ;?></p>
                                        </div>
                                        <!--div class="post-tags">
                                ...
                                <div class="comment-box">
                                    <div class="comment">
                                        <figure class="thumb-box">
                                            <img src="<?php echo base_url().'siproperty/assets/images/news/comment-1.jpg';?>" alt="">
                                        </figure>
                                    ...
                                    <div class="comment replay-comment">
                                        <figure class="thumb-box">
                                            <img src="<?php echo base_url().'siproperty/assets/images/news/comment-2.jpg';?>" alt="">
                                        </figure>
                                        <div class="comment-inner">
                                            <div class="comment-info clearfix">
                                    ...
                                    <div class="comment">
                                        <figure class="thumb-box">
                                            <img src="<?php echo base_url().'siproperty/assets/images/news/comment-3.jpg';?>" alt="">
                                        </figure>
                                        <div class="comment-inner">
                                            <div class="comment-info clearfix">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div class="blog-sidebar">
                            ...
                            <li><a href="<?php echo $settings->TwitterLink;?>"><i class="fab fa-twitter"></i></a></li>
                            <li><a href="<?php echo $settings->pinterest;?>"><i class="fab fa-pinterest-p"></i></a></li>
                            <li><a href="<?php echo $settings->insta;?>"><i class="fab fa-instagram"></i></a></li>
                            <li><a href="<?php echo $settings->YouTubeLink;?>"><i class="fab fa-youtube"></i></a></li>
        ...
        foreach($blogdesc as $blg){
            ...
            ?>
                                    ...
                                    <div class="post">
                                        ...
                                        <span class="post-date"><?php //$date=Date('');

echo $month = date('d',strtotime($date));?> <?php echo $month = date('M',strtotime($date));?>, <?php echo $datedt[0];?></span>
                                    </div>
                                    <?php }
                                ...
                                $i++;
                                    ...
                                    <!--div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img src="<?php echo base_url().'siproperty/assets/images/news/post-2.jpg';?>" alt=""></a></figure>
                                        <h5><a href="blog-details.html">A digital prescription for the industry.</a></h5>
                                        <span class="post-date">April 09, 2020</span>
                                    </div>
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img src="<?php echo base_url().'siproperty/assets/images/news/post-3.jpg';?>" alt=""></a></figure>
